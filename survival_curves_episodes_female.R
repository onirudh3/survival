...
saveRDS(p$plot + theme(plot.title = element_text(size = 30, hjust = 0.5)),
        file = "Survival by Episode/sickness_female.RDS")
...
p$plot + theme(plot.title = element_text(size = 30, hjust = 0.5)) +
  ...
  ylab("Proportion not having experienced risk")
saveRDS(p$plot + theme(plot.title = element_text(size = 30, hjust = 0.5)),
        file = "Survival by Episode/cut_self_female.RDS")
...
p$plot + theme(plot.title = element_text(size = 30, hjust = 0.5)) +
  ...
  ylab("Proportion not having experienced risk")
saveRDS(p$plot + theme(plot.title = element_text(size = 30, hjust = 0.5)),
        file = "Survival by Episode/Animal_Attack_female.RDS")
...
p$plot + theme(plot.title = element_text(size = 30, hjust = 0.5)) +
  ...
  ylab("Proportion not having experienced risk")
saveRDS(p$plot + theme(plot.title = element_text(size = 30, hjust = 0.5)),
        file = "Survival by Episode/tree_fall_female.RDS")
...
p$plot + theme(plot.title = element_text(size = 30, hjust = 0.5)) +
  ...
  ylab("Proportion not having experienced risk")
saveRDS(p$plot + theme(plot.title = element_text(size = 30, hjust = 0.5)),
        file = "Survival by Episode/fight_female.RDS")
...
p$plot + theme(plot.title = element_text(size = 30, hjust = 0.5)) +
  ...
  ylab("Proportion not having experienced risk")
saveRDS(p$plot + theme(plot.title = element_text(size = 30, hjust = 0.5)),
        file = "Survival by Episode/canoe_capsize_female.RDS")

# Panel plot --------------------------------------------------------------

figure <- ggarrange(readRDS("Survival by Episode/sickness_female.RDS"),
                    readRDS("Survival by Episode/cut_self_female.RDS"),
                    readRDS("Survival by Episode/Animal_Attack_female.RDS"),
                    readRDS("Survival by Episode/tree_fall_female.RDS"),
                    readRDS("Survival by Episode/fight_female.RDS"),
                    readRDS("Survival by Episode/canoe_capsize_female.RDS"))

pdf(file = "Survival by Episode/panel_plot_female.pdf", height = 9, width = 15)
