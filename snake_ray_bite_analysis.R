...
df_long <- read.csv("snake_ray_bite_final_table.csv") # longer interval format
df_first <- read.csv("snake_ray_bite_time_to_first_risk_long_interval.csv") # time to first risk long interval format
...
# Model 1: Sex ------------------------------------------------------------
model1 <- coxph(Surv(enter, exit, bite.during.interval) ~ male, data = df)
summary(model1)
...
addtorow$command <- c('\\hline ',
                      '\\hline ',
                      '\\hline ')
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model1.tex")

# Model 2: Sex + Risk -----------------------------------------------------

## Model 2a: Sex + Tree Fall ----
model2a <- coxph(Surv(enter, exit, bite.during.interval) ~ male +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model2a.tex")

## Model 2b: Sex + Sickness ----
model2b <- coxph(Surv(enter, exit, bite.during.interval) ~ male +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model2b.tex")

## Model 2c: Sex + Fight ----
model2c <- coxph(Surv(enter, exit, bite.during.interval) ~ male +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model2c.tex")

## Model 2d: Sex + Animal Attack ----
model2d <- coxph(Surv(enter, exit, bite.during.interval) ~ male +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model2d.tex")

## Model 2e: Sex + Canoe Capsize ----
model2e <- coxph(Surv(enter, exit, bite.during.interval) ~ male +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model2e.tex")

## Model 2f: Sex + Cut Self ----
model2f <- coxph(Surv(enter, exit, bite.during.interval) ~ male +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model2f.tex")


# Model 3: Sex + Region + Risk --------------------------------------------

## Model 3a: Sex + Region + Tree Fall ----
model3a <- coxph(Surv(enter, exit, bite.during.interval) ~ male + region +
                    tree.fall.during.interval, data = df)
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model3a.tex")

# Plot
pdf(file = "Snake Bite Plots/model3a.pdf", height = 5, width = 5)
plot(coxreg(Surv(enter, exit, bite.during.interval) ~ male + region +
              strata(tree.fall.during.interval), data = df),
     main = "Snake/Ray Bite (Controlling for Sex and Region)",
     xlab = "Age in Years",
...
model3b <- coxph(Surv(enter, exit, bite.during.interval) ~ male + region +
                    sickness.during.interval, data = df)
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model3b.tex")
...
model3c <- coxph(Surv(enter, exit, bite.during.interval) ~ male + region +
                    fought.during.interval, data = df)
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model3c.tex")
...
model3d <- coxph(Surv(enter, exit, bite.during.interval) ~ male + region +
                    animal.attack.during.interval, data = df)
# Warning message:
#   In survival::agreg.fit(X, Y, stratum, offset, init, control, weights = weights,  :
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model3d.tex")
...
model3e <- coxph(Surv(enter, exit, bite.during.interval) ~ male + region +
                    canoe.capsize.during.interval, data = df)
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model3e.tex")
...
model3f <- coxph(Surv(enter, exit, bite.during.interval) ~ male + region +
                    cut.self.during.interval, data = df)
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model3f.tex")
...
model4a <- coxph(Surv(enter, exit, bite.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model4a.tex")

## Model 4b: Sex + Region + Sickness + Sex*Sickness ----
model4b <- coxph(Surv(enter, exit, bite.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model4b.tex")

## Model 4c: Sex + Region + Fight + Sex*Fight ----
model4c <- coxph(Surv(enter, exit, bite.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model4c.tex")

## Model 4d: Sex + Region + Animal Attack + Sex*Animal Attack ----
model4d <- coxph(Surv(enter, exit, bite.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model4d.tex")

## Model 4e: Sex + Region + Canoe Capsize + Sex*Canoe Capsize ----
model4e <- coxph(Surv(enter, exit, bite.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model4e.tex")

## Model 4f: Sex + Region + Cut Self + Sex*Cut Self ----
model4f <- coxph(Surv(enter, exit, bite.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model4f.tex")



# Model 5: Sex + Region + Length of Last Snake/Ray Bite + Risk ------------------

# Create new df with no NAs in length.of.last.bite
new_df <- df_long %>%
  tidyr::drop_na(length.of.last.bite)
...
## Model 5a: Length of Last Snake/Ray Bite ----
model5a <- coxph(Surv(enter, exit, event) ~ length.of.last.bite,
                  data = new_df)
...
results <- data.frame(t(results))
results <- results %>% rename("Length of Prior Snake/Ray Bite Interval" = "t.results.")
results <- round(results, 3)
results <- results %>%
  mutate("No. of Individuals" = c("", "388", ""),
         "No. of Intervals" = c("", "13,451", ""),
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model5a.tex")

## Model 5b: Length of Prior Snake/Ray Bite + Sex ----
model5b <- coxph(Surv(enter, exit, event) ~ length.of.last.bite + male,
                  data = new_df)
...
results <- data.frame(t(results))
results <- results %>% rename("Male" = "male",
                              "Length of Prior Snake/Ray Bite Interval" = "length.of.last.bite")
results <- round(results, 3)
results <- results %>%
  mutate("No. of Individuals" = c("", "388", ""),
         "No. of Intervals" = c("", "13,451", ""),
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model5b.tex")

## Model 5c: Length of Prior Snake/Ray Bite + Sex + Region ----
model5c <- coxph(Surv(enter, exit, event) ~ length.of.last.bite + male +
                    region, data = new_df)
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model5c.tex")

## Model 5d: Length of Prior Snake/Ray Bite + Tree Fall ----
model5d <- coxph(Surv(enter, exit, event) ~ length.of.last.bite +
...
results <- data.frame(t(results))
results <- results %>% rename("Length of Prior Snake/Ray Bite Interval" = "length.of.last.bite",
                              "Tree Fall" = "tree.fall.during.interval")
results <- round(results, 3)
results <- results %>%
  mutate("No. of Individuals" = c("", "388", ""),
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model5d.tex")

## Model 5e: Length of Prior Snake/Ray Bite + Sickness ----
model5e <- coxph(Surv(enter, exit, event) ~ length.of.last.bite +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model5e.tex")

## Model 5f: Length of Prior Snake/Ray Bite + Fight ----
model5f <- coxph(Surv(enter, exit, event) ~ length.of.last.bite +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model5f.tex")

## Model 5g: Length of Prior Snake/Ray Bite + Animal Attack ----
model5g <- coxph(Surv(enter, exit, event) ~ length.of.last.bite +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model5g.tex")

## Model 5h: Length of Prior Snake/Ray Bite + Canoe Capsize ----
model5h <- coxph(Surv(enter, exit, event) ~ length.of.last.bite +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model5h.tex")

## Model 5i: Length of Prior Snake/Ray Bite + Cut Self ----
model5i <- coxph(Surv(enter, exit, event) ~ length.of.last.bite +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model5i.tex")


# Model 6: Mixed effects --------------------------------------------------
df_first <- read.csv("snake_ray_bite_time_to_first_risk_short_interval.csv") # time to first risk short interval format

## Null Model
model6 <- coxph(Surv(exit, bite.during.interval) ~ 1, data = df_first)
# summary(model6)

# Proportional hazards test
c <- eha::logrank(Surv(exit, bite.during.interval), male, df_first)
c <- data.frame("Chisq" = c$test.statistic, "df" = c$df, "p" = c$p.value)
stargazer(c, summary = F, title = "Snake/Ray Bite Log-rank Test Results for Sex", rownames = F,
          out = "Snake Bite Tables/logranktest3.tex")

d <- eha::logrank(Surv(exit, bite.during.interval), region, df_first)
d <- data.frame("Chisq" = d$test.statistic, "df" = d$df, "p" = d$p.value)
stargazer(d, summary = F, title = "Snake/Ray Bite Log-rank Test Results for Region", rownames = F,
          out = "Snake Bite Tables/logranktest4.tex")

## Model 6a: Null with random intercept for pid ----
model6a <- coxme(Surv(exit, bite.during.interval) ~ 1 + (1 | pid),
                 data = df_first)
# summary(model6a)

## Model 6b: Null with random intercepts for pid and house.id ----
model6b <- coxme(Surv(exit, bite.during.interval) ~ 1 + (1 | pid) +
                   (1 | house.id), data = df_first)
# summary(model6b)

## Model 6c: Null with random intercepts for pid, house.id and region ----
model6c <- coxme(Surv(exit, bite.during.interval) ~ 1 + (1 | pid) +
                   (1 | house.id) + (1 | region), data = df_first)
# summary(model6c)

## Model 6d: Null with region FE and pid, house.id RE ----
model6d <- coxme(Surv(exit, bite.during.interval) ~ 1 + (1 | pid) +
                   (1 | house.id) + region, data = df_first)
# summary(model6d)

## Model 6e: Nested RE ----
model6e <- coxme(Surv(exit, bite.during.interval) ~ 1 + (1 | pid) + (1 | region/house.id),
                 data = df_first)
# summary(model6e)
...
addtorow$command <- c('\\hline',
                      ...
                      '\\hline')
x <- xtable(df_coxme, caption = "Snake/Ray Bite Mixed Effects Specifications")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model6.tex")

## Model 6f: Tree Fall ----
model6f <- coxme(Surv(exit, bite.during.interval) ~ strata(male) + (1 | pid) +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model6f.tex")

# Plot Schoenfeld residuals
pdf(file = "Snake Bite Plots/schoenfeld_res1.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6f))
dev.off()


## Model 6g: Sickness ----
model6g <- coxme(Surv(exit, bite.during.interval) ~ strata(male) + (1 | pid) +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model6g.tex")

# Plot Schoenfeld residuals
pdf(file = "Snake Bite Plots/schoenfeld_res2.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6g))
dev.off()


## Model 6h: Fight ----
model6h <- coxme(Surv(exit, bite.during.interval) ~ strata(male) + (1 | pid) +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model6h.tex")

# Plot Schoenfeld residuals
pdf(file = "Snake Bite Plots/schoenfeld_res3.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6h))
dev.off()


## Model 6i: Canoe Capsize ----
model6i <- coxme(Surv(exit, bite.during.interval) ~ strata(male) + (1 | pid) +
...
x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model6i.tex")

# Plot Schoenfeld residuals
pdf(file = "Snake Bite Plots/schoenfeld_res4.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6i))
dev.off()


## Model 6j: Animal Attack ---- ERROR
# model6j <- coxme(Surv(exit, bite.during.interval) ~ strata(male) + (1 | pid) +
...
# x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
# align(x) <- "lcccccc"
# print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model6j.tex")
#
# # Plot Schoenfeld residuals
# pdf(file = "Snake Bite Plots/schoenfeld_res5.pdf", height = 5, width = 7)
# ggcoxzph(cox.zph(model6j))
# dev.off()


# ## Model 6k: Animal Attack (c) ----
# model6k <- coxme(Surv(exit, bite.during.interval) ~ strata(male) + (1 | pid) +
...
# x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
# align(x) <- "lcccccc"
# print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model6k.tex")
#
# # Plot Schoenfeld residuals
# pdf(file = "Snake Bite Plots/schoenfeld_res6.pdf", height = 5, width = 7)
# ggcoxzph(cox.zph(model6k))
# dev.off()


## Model 6l: Cut Self ---- ERROR
# model6l <- coxme(Surv(exit, bite.during.interval) ~ strata(male) + (1 | pid) +
...
# x <- xtable(results, caption = "Snake/Ray Bite \\vspace{-1em}")
# align(x) <- "lcccccc"
# print(x, caption.placement = "top", add.to.row = addtorow, file = "Snake Bite Tables/model6l.tex")
#
# # Plot Schoenfeld residuals
# pdf(file = "Snake Bite Plots/schoenfeld_res7.pdf", height = 5, width = 7)
...
## Percentage of intervals where Snake/Ray Bite occurred by age category ----
# Bar plot
pdf(file = "Snake Bite Plots/descriptive_plot1.pdf", height = 5,
    width = 7)
df %>%
  ...
  ggplot() +
  geom_col(aes(x = age.cat, y = prop), fill = "chartreuse3") +
...
# Line plot
pdf(file = "Snake Bite Plots/descriptive_plot2.pdf", height = 5,
    width = 7)
df %>%
  count(age.cat, bite.during.interval) %>%
  mutate(prop = prop.table(n)) %>%
  filter(bite.during.interval == 1) %>%
  ggplot() +
  geom_line(aes(x = age.cat, y = prop, group = 1), color = "chartreuse3",
            size = 2) +
  geom_text(aes(x = age.cat, y = prop,
...
pdf(file = "Snake Bite Plots/descriptive_plot3.pdf", height = 5, width = 7.5)
...
### Tree Fall ----
# Distribution of co-occurring Tree Fall within Snake/Ray Bite age intervals
pdf(file = "Snake Bite Plots/co_occurrence1a.pdf", height = 5, width = 7)
df_long %>%
  ...
  ggtitle("SNAKE/RAY BITE and TREE FALL") +
  theme(plot.title = element_text(size = 25)) +
  xlab("Age of Co-occurrence") +
  ylab("Percentage of Intervals (638 Intervals)")
dev.off()

# By gender
pdf(file = "Snake Bite Plots/co_occurrence1b.pdf", height = 5, width = 10)
df_long %>%
...
### Sickness ----
# Distribution of co-occurring Sickness within Snake/Ray Bite age intervals
pdf(file = "Snake Bite Plots/co_occurrence2a.pdf", height = 5, width = 7)
df_long %>%
  ...
  scale_y_continuous(labels = scales::percent) +
  theme_classic(base_size = 15) +
  ggtitle("SNAKE/RAY BITE and SICKNESS") +
  theme(plot.title = element_text(size = 25)) +
  xlab("Age of Co-occurrence") +
  ylab("Percentage of Intervals (638 Intervals)")
dev.off()
...
# By gender
pdf(file = "Snake Bite Plots/co_occurrence2b.pdf", height = 5, width = 10)
df_long %>%
...
### Fight ----
# Distribution of co-occurring fought within Snake/Ray Bite age intervals
pdf(file = "Snake Bite Plots/co_occurrence3a.pdf", height = 5, width = 7)
df_long %>%
  ...
  scale_y_continuous(labels = scales::percent) +
  theme_classic(base_size = 15) +
  ggtitle("SNAKE/RAY BITE and FOUGHT") +
  theme(plot.title = element_text(size = 25)) +
  xlab("Age of Co-occurrence") +
  ylab("Percentage of Intervals (638 Intervals)")
dev.off()
...
# By gender
pdf(file = "Snake Bite Plots/co_occurrence3b.pdf", height = 5, width = 10)
df_long %>%
...
### Animal Attack ----
# Distribution of co-occurring animal attack within Snake/Ray Bite age intervals
pdf(file = "Snake Bite Plots/co_occurrence4a.pdf", height = 5, width = 7.5)
df_long %>%
  ...
  scale_y_continuous(labels = scales::percent) +
  theme_classic(base_size = 15) +
  ggtitle("SNAKE/RAY BITE and ANIMAL ATTACK") +
  theme(plot.title = element_text(size = 25)) +
  xlab("Age of Co-occurrence") +
  ylab("Percentage of Intervals (638 Intervals)")
dev.off()
...
# By gender
pdf(file = "Snake Bite Plots/co_occurrence4b.pdf", height = 5, width = 10)
df_long %>%
  ...
  theme_classic(base_size = 15) +
  ggtitle("SNAKE/RAY BITE and ANIMAL ATTACK") +
  labs(subtitle = "No females experienced co-occurrence of snake/ray bite and animal attack") +
  theme(plot.title = element_text(size = 30)) +
  xlab("Age of Co-occurrence") +
  ylab("Percentage of Intervals (638 Intervals)") +
  facet_wrap(~male) + theme(strip.text.x = element_text(size = 20)) +
...
### Canoe Capsize ----
# Distribution of co-occurring canoe capsize within Snake/Ray Bite age intervals
pdf(file = "Snake Bite Plots/co_occurrence5a.pdf", height = 5, width = 7.5)
df_long %>%
  ...
  scale_y_continuous(labels = scales::percent) +
  theme_classic(base_size = 15) +
  ggtitle("SNAKE/RAY BITE and CANOE CAPSIZE") +
  theme(plot.title = element_text(size = 25)) +
  xlab("Age of Co-occurrence") +
  ylab("Percentage of Intervals (638 Intervals)")
dev.off()
...
# By gender
pdf(file = "Snake Bite Plots/co_occurrence5b.pdf", height = 5, width = 10)
df_long %>%
...
### Cut Self ----
# Distribution of co-occurring cut self within Snake/Ray Bite age intervals
pdf(file = "Snake Bite Plots/co_occurrence6a.pdf", height = 5, width = 7)
df_long %>%
  ...
  scale_y_continuous(labels = scales::percent) +
  theme_classic(base_size = 15) +
  ggtitle("SNAKE/RAY BITE and CUT SELF") +
  theme(plot.title = element_text(size = 25)) +
  xlab("Age of Co-occurrence") +
  ylab("Percentage of Intervals (638 Intervals)")
dev.off()
...
# By gender
pdf(file = "Snake Bite Plots/co_occurrence6b.pdf", height = 5, width = 10)
df_long %>%
...
df_long$event <- ifelse(df_long$event == 1, "Snake/Ray Bite
Occurred", "Snake/Ray Bite Did
Not Occur")
...
pdf(file = "Snake Bite Plots/co_occurrence1c.pdf", height = 4, width = 6.5)
df_long %>%
...
pdf(file = "Snake Bite Plots/co_occurrence1d.pdf", height = 4, width = 7)
df_long %>%
...
# By region
pdf(file = "Snake Bite Plots/co_occurrence1e.pdf", height = 4.5, width = 7)
df_long %>%
...
pdf(file = "Snake Bite Plots/co_occurrence2c.pdf", height = 4, width = 6.5)
df_long %>%
...
# For males and females
pdf(file = "Snake Bite Plots/co_occurrence2d.pdf", height = 4, width = 7)
df_long %>%
...
# By region
pdf(file = "Snake Bite Plots/co_occurrence2e.pdf", height = 4, width = 7.5)
df_long %>%
...
pdf(file = "Snake Bite Plots/co_occurrence3c.pdf", height = 4, width = 6)
df_long %>%
...
# For males and females
pdf(file = "Snake Bite Plots/co_occurrence3d.pdf", height = 4, width = 7)
df_long %>%
...
# By region
pdf(file = "Snake Bite Plots/co_occurrence3e.pdf", height = 4, width = 7)
df_long %>%
...
pdf(file = "Snake Bite Plots/co_occurrence4c.pdf", height = 4, width = 6)
df_long %>%
...
# For males and females
pdf(file = "Snake Bite Plots/co_occurrence4d.pdf", height = 4, width = 7.5)
df_long %>%
...
# By region
pdf(file = "Snake Bite Plots/co_occurrence4e.pdf", height = 4.5, width = 7)
df_long %>%
...
pdf(file = "Snake Bite Plots/co_occurrence5c.pdf", height = 4, width = 6)
df_long %>%
...
# For males and females
pdf(file = "Snake Bite Plots/co_occurrence5d.pdf", height = 4, width = 8)
df_long %>%
...
# By region
pdf(file = "Snake Bite Plots/co_occurrence5e.pdf", height = 4.5, width = 7.5)
df_long %>%
...
pdf(file = "Snake Bite Plots/co_occurrence6c.pdf", height = 4, width = 6)
df_long %>%
...
# For males and females
pdf(file = "Snake Bite Plots/co_occurrence6d.pdf", height = 4, width = 7)
df_long %>%
...
# By region
pdf(file = "Snake Bite Plots/co_occurrence6e.pdf", height = 4.5, width = 7)
df_long %>%
...
## Survival Function ----
fit <- survfit(Surv(enter, exit, bite.during.interval) ~ 1, data = df)
pdf(file = "Snake Bite Plots/survival_function.pdf", height = 5, width = 6)
autoplot(fit, censor.shape = '|', censor.colour = "chartreuse3",
         surv.colour = "chartreuse3") +
...
stargazer(gg, summary = F, out = "Snake Bite Tables/risk_table.tex",
          title = "Snake/Ray Bite \\vspace{-1.4em}", rownames = F,
          digits = 2)

# By gender
fit2 <- survfit(Surv(enter, exit, bite.during.interval) ~ male, data = df)
pdf(file = "Snake Bite Plots/survival_function_by_gender.pdf", height = 5)
ggsurvplot(fit2, font.title = c("30"), conf.int = TRUE, legend = "right",
           ...
           title = "Snake/Ray Bite", axes.offset = F, break.x.by = 5,
...
## Hazard Function ----
### bshazard ----
fit <- bshazard(Surv(enter, exit, bite.during.interval) ~ 1, data = df)
df_surv <- data.frame(time = fit$time, hazard = fit$hazard,
                      lower.ci = fit$lower.ci, upper.ci = fit$upper.ci)
pdf(file = "Snake Bite Plots/hazard_function1.pdf", height = 5)
...
df_surv <- df_surv %>% rename("Age (Years)" = "time",
                              ...
                              "Lower CI" = "lower.ci",
                              "Upper CI" = "upper.ci")
stargazer(df_surv, summary = F, out = "Snake Bite Tables/hazard_table.tex",
          title = "Snake/Ray Bite \\vspace{-1.4em}", rownames = F,
          notes = "\\tiny Note: Snake/Ray Bite hazard begins from the age interval 3-4 onward.")

### muhaz ----
pdf(file = "Snake Bite Plots/hazard_function2.pdf", height = 5)
mfit <- muhaz(df$exit, df$bite.during.interval)
plot(mfit, main = "SNAKE/RAY BITE")
dev.off()

pdf(file = "Snake Bite Plots/hazard_function3.pdf", height = 5)
kfit <- kphaz.fit(df$exit, df$bite.during.interval)
kphaz.plot(kfit, main = "SNAKE/RAY BITE")
dev.off()


# By gender
fit <- bshazard(Surv(enter, exit, bite.during.interval) ~ 1, data = subset(df, male == "Male"))
summary(fit)
df_surv <- data.frame(time = fit$time, hazard = fit$hazard,
                      lower.ci = fit$lower.ci, upper.ci = fit$upper.ci)
df_surv$Sex <- "Male"

fit2 <- bshazard(Surv(enter, exit, bite.during.interval) ~ 1, data = subset(df, male == "Female"))
summary(fit2)
...
pdf(file = "Snake Bite Plots/hazard_function4.pdf", height = 5)
...
pdf(file = "Snake Bite Plots/hazard_function5.pdf", height = 5)
ggplot(df_surv4) +
...
# fit <- stpm2(Surv(enter, exit, bite.during.interval) ~ male, data = df)
# plot(fit, newdata = data.frame(male = 1), type = "hr", var = "male")

## Cumulative hazard function ----
fit <- survfit(Surv(enter, exit, bite.during.interval) ~ 1, data = df)
pdf(file = "Snake Bite Plots/cumhaz_plot1.pdf", height = 5)
autoplot(fit, censor.shape = '|', censor.colour = "chartreuse3",
         surv.colour = "chartreuse3", fun = "cumhaz") +
  theme_classic(base_size = 14) +
  ggtitle("Snake/Ray Bite") +
  theme(plot.title = element_text(size = 30)) +
  xlab("Age in years") +
...
# By gender
fit2 <- survfit(Surv(enter, exit, bite.during.interval) ~ male, data = df)
pdf(file = "Snake Bite Plots/cumhaz_plot2.pdf", height = 5)
ggsurvplot(fit2, font.title = c("30"), conf.int = TRUE, legend = "right",
           legend.labs = c("Female", "Male"),
           legend.title = "Sex", palette = c("orchid2", "dodgerblue2"),
           title = "Snake/Ray Bite", fun = "cumhaz", axes.offset = F, break.x.by = 5,
           subtitle = "388 Individuals, 13,451 Intervals") +
  xlab("Age in years") +
  ylab("Cumulative hazard")
dev.off()
