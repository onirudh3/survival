...
summary(model2g)
stargazer(model2g, type = "latex", title = "Fight \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model3g <- coxreg(Surv(enter, exit, fought.during.interval) ~ male + region +
                    Animal_Attack.during.interval, data = df)
summary(model3g)
stargazer(model3g, type = "latex", title = "Fight \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model4g <- coxreg(Surv(enter, exit, fought.during.interval) ~ male + region +
                  ...
                  data = df)
summary(model4g)
stargazer(model4g, type = "latex", title = "Fight \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
summary(model5j)
stargazer(model5j, type = "latex", title = "Fight \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
