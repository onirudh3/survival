...
# Sex ---------------------------------------------------------------------
# PH violated for sex
model2 <- coxme(Surv(exit, fought.during.interval) ~ strata(male) +
                  (1 | pid) + (1 | house.id), df)
c <- data.frame(t(data.frame(VarCorr(model2))))
colnames(c) <- c("RE Variance")
print(xtable(c), file = "Fight Tables/sexvar.tex")
...
# Sex + Region ------------------------------------------------------------
# PH violated for region
model5 <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + strata(region) +
                  (1 | pid), df)
...
# Tree Fall
model5a <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + strata(region) +
                   tree.fall.during.interval + (1 | pid), df)
saveRDS(model5a, file = "Fight Tables/region_tree_fall_1.RDS")
...
# Sickness
model5b <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + strata(region) +
                   sickness.during.interval + (1 | pid), df)
saveRDS(model5b, file = "Fight Tables/region_sickness_1.RDS")
...
# Animal Attack
model5c <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + strata(region) +
                   Animal_Attack.during.interval + (1 | pid), df)
saveRDS(model5c, file = "Fight Tables/region_Animal_Attack_1.RDS")
...
# Cut Self
model5d <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + strata(region) +
                   cut.self.during.interval + (1 | pid), df)
saveRDS(model5d, file = "Fight Tables/region_cut_self_1.RDS")
...
# Canoe Capsize
model5e <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + strata(region) +
                   canoe.capsize.during.interval + (1 | pid), df)
saveRDS(model5e, file = "Fight Tables/region_canoe_capsize_1.RDS")
...
# Tree Fall
model6a <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + strata(region) + strata(tercile) +
                   tree.fall.during.interval + (1 | pid), df)
saveRDS(model6a, file = "Fight Tables/tercile_tree_fall_1.RDS")
...
# Sickness
model6b <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + strata(region) + strata(tercile) +
                   sickness.during.interval + (1 | pid), df)
saveRDS(model6b, file = "Fight Tables/tercile_sickness_1.RDS")
...
# Animal Attack
model6c <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + strata(region) + strata(tercile) +
                   Animal_Attack.during.interval + (1 | pid), df)
saveRDS(model6c, file = "Fight Tables/tercile_Animal_Attack_1.RDS")
...
# Cut Self
model6d <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + strata(region) + strata(tercile) +
                   cut.self.during.interval + (1 | pid), df)
saveRDS(model6d, file = "Fight Tables/tercile_cut_self_1.RDS")
...
# Canoe Capsize
model6e <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + strata(region) + strata(tercile) +
                   canoe.capsize.during.interval + (1 | pid), df)
saveRDS(model6e, file = "Fight Tables/tercile_canoe_capsize_1.RDS")
