...
df_first <- read.csv("fought_time_to_first_risk_long_interval.csv") # time to first risk long interval format
...
# Model 1: Sex ------------------------------------------------------------
model1 <- coxph(Surv(enter, exit, fought.during.interval) ~ male, data = df)
summary(model1)
...
eha::logrank(Surv(enter, exit, fought.during.interval), group = region, data = df)

# # Testing Proportional Hazards for calendar year tercile
# df <- read.csv("fought_time_to_first_risk_short_interval.csv")
# eha::logrank(Surv(enter, exit, fought.during.interval), group = tercile, data = df)
# plot(survfit(Surv(enter, exit, fought.during.interval) ~ tercile, df))
...
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model1.tex")

# Model 2: Sex + Risk -----------------------------------------------------

## Model 2a: Sex + Tree Fall ----
model2a <- coxph(Surv(enter, exit, fought.during.interval) ~ male +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model2a.tex")

## Model 2b: Sex + Sickness ----
model2b <- coxph(Surv(enter, exit, fought.during.interval) ~ male +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model2b.tex")

## Model 2c: Sex + Snake/Ray Bite ----
model2c <- coxph(Surv(enter, exit, fought.during.interval) ~ male +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model2c.tex")

## Model 2d: Sex + Animal Attack ----
model2d <- coxph(Surv(enter, exit, fought.during.interval) ~ male +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model2d.tex")

## Model 2e: Sex + Canoe Capsize ----
model2e <- coxph(Surv(enter, exit, fought.during.interval) ~ male +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model2e.tex")

## Model 2f: Sex + Cut Self ----
model2f <- coxph(Surv(enter, exit, fought.during.interval) ~ male +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model2f.tex")

## Model 2g: Sex + Animal Attack (c) ----
model2g <- coxph(Surv(enter, exit, fought.during.interval) ~ male +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model2g.tex")


# Model 3: Sex + Region + Risk --------------------------------------------

## Model 3a: Sex + Region + Tree Fall ----
model3a <- coxph(Surv(enter, exit, fought.during.interval) ~ male + region +
                    tree.fall.during.interval, data = df)
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model3a.tex")
...
model3b <- coxph(Surv(enter, exit, fought.during.interval) ~ male + region +
                    sickness.during.interval, data = df)
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model3b.tex")
...
model3c <- coxph(Surv(enter, exit, fought.during.interval) ~ male + region +
                    bite.during.interval, data = df)
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model3c.tex")
...
model3d <- coxph(Surv(enter, exit, fought.during.interval) ~ male + region +
                    animal.attack.during.interval, data = df)
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model3d.tex")
...
model3e <- coxph(Surv(enter, exit, fought.during.interval) ~ male + region +
                    canoe.capsize.during.interval, data = df)
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model3e.tex")
...
model3f <- coxph(Surv(enter, exit, fought.during.interval) ~ male + region +
                    cut.self.during.interval, data = df)
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model3f.tex")
...
model3g <- coxph(Surv(enter, exit, fought.during.interval) ~ male + region +
                    Animal_Attack.during.interval, data = df)
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model3g.tex")

# Plot
pdf(file = "Fight Plots/model3g.pdf", height = 5, width = 5)
plot(coxreg(Surv(enter, exit, fought.during.interval) ~ male + region +
...
model4a <- coxph(Surv(enter, exit, fought.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model4a.tex")

## Model 4b: Sex + Region + Sickness + Sex*Sickness ----
model4b <- coxph(Surv(enter, exit, fought.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model4b.tex")

## Model 4c: Sex + Region + Snake/Ray Bite + Sex*Snake/Ray Bite ----
model4c <- coxph(Surv(enter, exit, fought.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model4c.tex")

## Model 4d: Sex + Region + Animal Attack + Sex*Animal Attack ----
model4d <- coxph(Surv(enter, exit, fought.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model4d.tex")

## Model 4e: Sex + Region + Canoe Capsize + Sex*Canoe Capsize ----
model4e <- coxph(Surv(enter, exit, fought.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model4e.tex")

## Model 4f: Sex + Region + Cut Self + Sex*Cut Self ----
model4f <- coxph(Surv(enter, exit, fought.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model4f.tex")

## Model 4g: Sex + Region + Animal Attack (c) + Sex*Animal Attack (c) ----
model4g <- coxph(Surv(enter, exit, fought.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model4g.tex")
...
model5a <- coxph(Surv(enter, exit, event) ~ length.of.last.fight,
                  data = new_df)
...
results <- data.frame(t(results))
results <- results %>% rename("Length of Prior Fight Interval" = "t.results.")
results <- round(results, 3)
results <- results %>%
  mutate("No. of Individuals" = c("", "388", ""),
         "No. of Intervals" = c("", "13,451", ""),
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model5a.tex")

## Model 5b: Length of Prior Fight + Sex ----
model5b <- coxph(Surv(enter, exit, event) ~ length.of.last.fight + male,
                  data = new_df)
...
results <- data.frame(t(results))
results <- results %>% rename("Male" = "male",
                              "Length of Prior Fight Interval" = "length.of.last.fight")
results <- round(results, 3)
results <- results %>%
  mutate("No. of Individuals" = c("", "388", ""),
         "No. of Intervals" = c("", "13,451", ""),
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model5b.tex")

## Model 5c: Length of Prior Fight + Sex + Region ----
model5c <- coxph(Surv(enter, exit, event) ~ length.of.last.fight + male +
                    region, data = new_df)
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model5c.tex")

## Model 5d: Length of Prior Fight + Tree Fall ----
model5d <- coxph(Surv(enter, exit, event) ~ length.of.last.fight +
...
results <- data.frame(t(results))
results <- results %>% rename("Length of Prior Fight Interval" = "length.of.last.fight",
                              "Tree Fall" = "tree.fall.during.interval")
results <- round(results, 3)
results <- results %>%
  mutate("No. of Individuals" = c("", "388", ""),
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model5d.tex")

## Model 5e: Length of Prior Fight + Sickness ----
model5e <- coxph(Surv(enter, exit, event) ~ length.of.last.fight +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model5e.tex")

## Model 5f: Length of Prior Fight + Snake/Ray Bite ----
model5f <- coxph(Surv(enter, exit, event) ~ length.of.last.fight +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model5f.tex")

## Model 5g: Length of Prior Fight + Animal Attack ----
model5g <- coxph(Surv(enter, exit, event) ~ length.of.last.fight +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model5g.tex")

## Model 5h: Length of Prior Fight + Canoe Capsize ----
model5h <- coxph(Surv(enter, exit, event) ~ length.of.last.fight +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model5h.tex")

## Model 5i: Length of Prior Fight + Cut Self ----
model5i <- coxph(Surv(enter, exit, event) ~ length.of.last.fight +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model5i.tex")

## Model 5j: Length of Prior Fight + Animal Attack (c) ----
model5j <- coxph(Surv(enter, exit, event) ~ length.of.last.fight +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model5j.tex")



# Model 6: Mixed effects --------------------------------------------------
df_first <- read.csv("fought_time_to_first_risk_short_interval.csv") # time to first risk short interval format

## Null Model
model6 <- coxph(Surv(exit, fought.during.interval) ~ 1, data = df_first)
# summary(model6)

# Proportional hazards test
c <- eha::logrank(Surv(exit, fought.during.interval), male, df_first)
c <- data.frame("Chisq" = c$test.statistic, "df" = c$df, "p" = c$p.value)
stargazer(c, summary = F, title = "Fight Log-rank Test Results for Sex", rownames = F,
          out = "Fight Tables/logranktest3.tex")

d <- eha::logrank(Surv(exit, fought.during.interval), region, df_first)
d <- data.frame("Chisq" = d$test.statistic, "df" = d$df, "p" = d$p.value)
stargazer(d, summary = F, title = "Fight Log-rank Test Results for Region", rownames = F,
          out = "Fight Tables/logranktest4.tex")

## Model 6a: Null with random intercept for pid ----
model6a <- coxme(Surv(exit, fought.during.interval) ~ 1 + (1 | pid),
                 data = df_first)
# summary(model6a)

## Model 6b: Null with random intercepts for pid and house.id ----
model6b <- coxme(Surv(exit, fought.during.interval) ~ 1 + (1 | pid) +
                   (1 | house.id), data = df_first)
# summary(model6b)

## Model 6c: Null with random intercepts for pid, house.id and region ----
model6c <- coxme(Surv(exit, fought.during.interval) ~ 1 + (1 | pid) +
                   (1 | house.id) + (1 | region), data = df_first)
# summary(model6c)

## Model 6d: Null with region FE and pid, house.id RE ----
model6d <- coxme(Surv(exit, fought.during.interval) ~ 1 + (1 | pid) +
                   (1 | house.id) + region, data = df_first)
# summary(model6d)

## Model 6e: Nested RE ----
model6e <- coxme(Surv(exit, fought.during.interval) ~ 1 + (1 | pid) + (1 | region/house.id),
                 data = df_first)
# summary(model6e)

## Model 6f: Tree Fall ----
model6f <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + (1 | pid) +
                   (1 | house.id) + (1 | region) + tree.fall.during.interval, df_first)
saveRDS(model6f, file = "Fight Tables/coxme_tree_fall.RDS")
# a <- readRDS("stuff.RDS")
# object.size(model6f)
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model6f.tex")

# Plot Schoenfeld residuals
pdf(file = "Fight Plots/schoenfeld_res1.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6f))
dev.off()


## Model 6g: Sickness ----
model6g <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + (1 | pid) +
                   (1 | house.id) + (1 | region) + sickness.during.interval, df_first)
saveRDS(model6g, file = "Fight Tables/coxme_sickness.RDS")
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model6g.tex")

# Plot Schoenfeld residuals
pdf(file = "Fight Plots/schoenfeld_res2.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6g))
dev.off()


# ## Model 6h: Snake/Ray Bite ---- ERROR
# model6h <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + (1 | pid) +
...
# x <- xtable(results, caption = "Fight \\vspace{-1em}")
# align(x) <- "lcccccc"
# print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model6h.tex")
#
# # Plot Schoenfeld residuals
# pdf(file = "Fight Plots/schoenfeld_res3.pdf", height = 5, width = 7)
# ggcoxzph(cox.zph(model6h))
# dev.off()


## Model 6i: Canoe Capsize ----
model6i <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + (1 | pid) +
                   (1 | house.id) + (1 | region) + canoe.capsize.during.interval, df_first)
saveRDS(model6i, file = "Fight Tables/coxme_canoe_capsize.RDS")
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model6i.tex")

# Plot Schoenfeld residuals
pdf(file = "Fight Plots/schoenfeld_res4.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6i))
dev.off()


## Model 6j: Animal Attack ----
model6j <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + (1 | pid) +
                   (1 | house.id) + (1 | region) + animal.attack.during.interval, df_first)
saveRDS(model6j, file = "Fight Tables/coxme_animal_attack.RDS")
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model6j.tex")

# Plot Schoenfeld residuals
pdf(file = "Fight Plots/schoenfeld_res5.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6j))
dev.off()


## Model 6k: Animal Attack (c) ----
model6k <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + (1 | pid) +
                   (1 | house.id) + (1 | region) + Animal_Attack.during.interval, df_first)
saveRDS(model6k, file = "Fight Tables/coxme_animal_attack_combined.RDS")
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model6k.tex")

# Plot Schoenfeld residuals
pdf(file = "Fight Plots/schoenfeld_res6.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6k))
dev.off()


## Model 6l: Cut Self ----
model6l <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + (1 | pid) +
                   (1 | house.id) + (1 | region) + cut.self.during.interval, df_first)
saveRDS(model6l, file = "Fight Tables/coxme_cut_self.RDS")
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model6l.tex")

# Plot Schoenfeld residuals
pdf(file = "Fight Plots/schoenfeld_res7.pdf", height = 5, width = 7)
...
df_hazard_plot <- bind_rows(cbind(extract_coxme_table(readRDS("Fight Tables/coxme_tree_fall.RDS")), data.frame(confint(readRDS("Fight Tables/coxme_tree_fall.RDS")))),
                        cbind(extract_coxme_table(readRDS("Fight Tables/coxme_sickness.RDS")), data.frame(confint(readRDS("Fight Tables/coxme_sickness.RDS")))),
                        # cbind(extract_coxme_table(readRDS("Fight Tables/coxme_animal_attack.RDS")), data.frame(confint(readRDS("Fight Tables/coxme_animal_attack.RDS")))),
                        cbind(extract_coxme_table(readRDS("Fight Tables/coxme_animal_attack_combined.RDS")), data.frame(confint(readRDS("Fight Tables/coxme_animal_attack_combined.RDS")))),
                        cbind(extract_coxme_table(readRDS("Fight Tables/coxme_cut_self.RDS")), data.frame(confint(readRDS("Fight Tables/coxme_cut_self.RDS")))),
                        cbind(extract_coxme_table(readRDS("Fight Tables/coxme_canoe_capsize.RDS")), data.frame(confint(readRDS("Fight Tables/coxme_canoe_capsize.RDS")))))
...
ph_df <- bind_rows(data.frame(cox.zph(readRDS("Fight Tables/coxme_tree_fall.RDS"))$table),
                   data.frame(cox.zph(readRDS("Fight Tables/coxme_sickness.RDS"))$table),
                   data.frame(cox.zph(readRDS("Fight Tables/coxme_animal_attack_combined.RDS"))$table),
                   data.frame(cox.zph(readRDS("Fight Tables/coxme_cut_self.RDS"))$table),
                   data.frame(cox.zph(readRDS("Fight Tables/coxme_canoe_capsize.RDS"))$table))
...
pdf(file = "Fight Plots/coxme_plot.pdf", height = 6.5, width = 6)
p <- df_hazard_plot %>%
  ggplot() +
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model8.tex")
...
align(x) <- "lccccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model6.tex")

# Model 9: calendar year median split -------------------------------------
model9 <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + pre_median + (1 | pid) +
                  (1 | house.id) + (1 | region), df_first)
saveRDS(model9, file = "Fight Tables/coxme_calendar_year_median.RDS")
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model9.tex")

# Plot Schoenfeld residuals
pdf(file = "Fight Plots/schoenfeld_res_median.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model9))
dev.off()

# Model 10: calendar year tercile split -------------------------------------

model10 <- coxme(Surv(exit, fought.during.interval) ~ strata(male) + tercile + (1 | pid) +
                   (1 | house.id) + (1 | region), df_first)
saveRDS(model10, file = "Fight Tables/coxme_calendar_year_tercile.RDS")
...
x <- xtable(results, caption = "Fight \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Fight Tables/model10.tex")

# Plot Schoenfeld residuals
pdf(file = "Fight Plots/schoenfeld_res_tercile.pdf", height = 5, width = 7)
...
### ANIMAL ATTACK (c) ----
# Distribution of co-occurring ANIMAL ATTACK (c) within Fight age intervals
pdf(file = "Fight Plots/co_occurrence7a.pdf", height = 5, width = 7)
df_long %>%
  count(cut.self.co_occurrence.interval) %>%
  mutate(prop = prop.table(n)) %>%
  filter(!is.na(cut.self.co_occurrence.interval)) %>%
...
# By gender
pdf(file = "Fight Plots/co_occurrence7b.pdf", height = 5, width = 10)
df_long %>%
  count(cut.self.co_occurrence.interval, male) %>%
  mutate(prop = prop.table(n)) %>%
  filter(!is.na(cut.self.co_occurrence.interval)) %>%
...
pdf(file = "Fight Plots/co_occurrence7c.pdf", height = 4, width = 6)
df_long %>%
  ...
  scale_y_continuous(labels = scales::percent_format(scale = 1)) +
  theme_classic(base_size = 12) +
  ggtitle("FIGHT and ANIMAL ATTACK (c)") +
  theme(plot.title = element_text(size = 25)) +
  xlab("") +
  ylab("Percentage of Intervals (543 Intervals)") +
  scale_fill_manual(values = c("lightcyan2", "lightcoral")) +
...
# For males and females
pdf(file = "Fight Plots/co_occurrence7d.pdf", height = 4, width = 7)
df_long %>%
...
# By region
pdf(file = "Fight Plots/co_occurrence7e.pdf", height = 4.5, width = 7)
df_long %>%
...
stargazer(gg, summary = F, out = "Fight Tables/risk_table.tex",
...
df_surv <- data.frame(time = fit$time, hazard = fit$hazard,
                      lower.ci = fit$lower.ci, upper.ci = fit$upper.ci)
df_surv <- round(df_surv, 3) # here we understand hazards begin from age 11 onward
...
df_surv <- df_surv %>% rename("Age (Years)" = "time",
                              ...
                              "Lower CI" = "lower.ci",
                              "Upper CI" = "upper.ci")
stargazer(df_surv, summary = F, out = "Fight Tables/hazard_table.tex",
          title = "Fight \\vspace{-1.4em}", rownames = F,
          notes = "\\tiny Note: Fight hazard begins from the age interval 10-11 onward.")
