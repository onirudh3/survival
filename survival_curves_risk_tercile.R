...
p
dev.off()
saveRDS(p, file = "Sickness Plots/survival_function_time_to_first_risk_by_tercile.RDS")
...
p
dev.off()
saveRDS(p, file = "Animal Attack Combined Plots/survival_function_time_to_first_risk_by_tercile.RDS")
...
p
dev.off()
saveRDS(p, file = "Tree Fall Plots/survival_function_time_to_first_risk_by_tercile.RDS")
...
p
dev.off()
saveRDS(p, file = "Fight Plots/survival_function_time_to_first_risk_by_tercile.RDS")
...
p
dev.off()
saveRDS(p, file = "Canoe Capsize Plots/survival_function_time_to_first_risk_by_tercile.RDS")

## Panel plot ----
figure <- ggarrange(readRDS("Sickness Plots/survival_function_time_to_first_risk_by_tercile.RDS") + annotate("rect", xmin = 0, xmax = 75, ymin = 0, ymax = Inf, alpha = 0.05, fill = "green") + rremove("ylab") + rremove("xlab"),
                    readRDS("Cut Self Plots/survival_function_time_to_first_risk_by_tercile.RDS") + annotate("rect", xmin = 0, xmax = 75, ymin = 0, ymax = Inf, alpha = 0.1, fill = "black") + rremove("ylab") + rremove("xlab"),
                    readRDS("Animal Attack Combined Plots/survival_function_time_to_first_risk_by_tercile.RDS") + annotate("rect", xmin = 0, xmax = 75, ymin = 0, ymax = Inf, alpha = 0.1, fill = "black") + rremove("ylab") + rremove("xlab"),
...
p
dev.off()
saveRDS(p, file = "Sickness Plots/survival_function_time_to_first_risk_by_tercile_male.RDS")
...
p
dev.off()
saveRDS(p, file = "Animal Attack Combined Plots/survival_function_time_to_first_risk_by_tercile_male.RDS")
...
p
dev.off()
saveRDS(p, file = "Tree Fall Plots/survival_function_time_to_first_risk_by_tercile_male.RDS")
...
p
dev.off()
saveRDS(p, file = "Fight Plots/survival_function_time_to_first_risk_by_tercile_male.RDS")
...
p
dev.off()
saveRDS(p, file = "Canoe Capsize Plots/survival_function_time_to_first_risk_by_tercile_male.RDS")

## Panel plot ----
figure <- ggarrange(readRDS("Sickness Plots/survival_function_time_to_first_risk_by_tercile_male.RDS") + annotate("rect", xmin = 0, xmax = 75, ymin = 0, ymax = Inf, alpha = 0.05, fill = "green") + rremove("ylab") + rremove("xlab"),
                    readRDS("Cut Self Plots/survival_function_time_to_first_risk_by_tercile_male.RDS") + annotate("rect", xmin = 0, xmax = 75, ymin = 0, ymax = Inf, alpha = 0.1, fill = "black") + rremove("ylab") + rremove("xlab"),
                    readRDS("Animal Attack Combined Plots/survival_function_time_to_first_risk_by_tercile_male.RDS") + annotate("rect", xmin = 0, xmax = 75, ymin = 0, ymax = Inf, alpha = 0.1, fill = "black") + rremove("ylab") + rremove("xlab"),
...
p
dev.off()
saveRDS(p, file = "Sickness Plots/survival_function_time_to_first_risk_by_tercile_female.RDS")
...
p
dev.off()
saveRDS(p, file = "Animal Attack Combined Plots/survival_function_time_to_first_risk_by_tercile_female.RDS")
...
p
dev.off()
saveRDS(p, file = "Tree Fall Plots/survival_function_time_to_first_risk_by_tercile_female.RDS")
...
p
dev.off()
saveRDS(p, file = "Fight Plots/survival_function_time_to_first_risk_by_tercile_female.RDS")
...
p
dev.off()
saveRDS(p, file = "Canoe Capsize Plots/survival_function_time_to_first_risk_by_tercile_female.RDS")

## Panel plot ----
figure <- ggarrange(readRDS("Sickness Plots/survival_function_time_to_first_risk_by_tercile_female.RDS") + annotate("rect", xmin = 0, xmax = 75, ymin = 0, ymax = Inf, alpha = 0.05, fill = "green") + rremove("ylab") + rremove("xlab"),
                    readRDS("Cut Self Plots/survival_function_time_to_first_risk_by_tercile_female.RDS") + annotate("rect", xmin = 0, xmax = 75, ymin = 0, ymax = Inf, alpha = 0.1, fill = "black") + rremove("ylab") + rremove("xlab"),
                    readRDS("Animal Attack Combined Plots/survival_function_time_to_first_risk_by_tercile_female.RDS") + annotate("rect", xmin = 0, xmax = 75, ymin = 0, ymax = Inf, alpha = 0.1, fill = "black") + rremove("ylab") + rremove("xlab"),
