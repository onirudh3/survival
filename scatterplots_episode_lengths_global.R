...
dz <- data.frame(ep1_time = dx[(dx$sickness.during.interval.episode == 1), ]$exit,
                 ep2_time = dx[(dx$sickness.during.interval.episode == 2), ]$exit)
dz <- dz %>% mutate(group = case_when(ep2_time %% 1 == 0 ~ 1, T ~ 2))
dz$ep2_time <- dz$ep2_time - dz$ep1_time
dz$group <- as.factor(dz$group)
p <- dz %>%
  ggplot(aes(ep1_time, ep2_time, shape = group)) +
  scale_shape_manual(values = c(20, 3)) +
...
saveRDS(p, file = "Scatterplot Episode Time/sickness_1_v_2_a.RDS")
...
dz <- data.frame(ep2_time = dx[(dx$sickness.during.interval.episode == 2), ]$exit,
                 ep3_time = dx[(dx$sickness.during.interval.episode == 3), ]$exit)
dz <- dz %>% mutate(group = case_when(ep3_time %% 1 == 0 ~ 1, T ~ 2))
dz$ep3_time <- dz$ep3_time - dz$ep2_time
dz$group <- as.factor(dz$group)
p <- dz %>%
  ggplot(aes(ep2_time, ep3_time, shape = group)) +
  scale_shape_manual(values = c(20, 3)) +
...
saveRDS(p, file = "Scatterplot Episode Time/sickness_2_v_3_a.RDS")
...
saveRDS(p, file = "Scatterplot Episode Time/cut_self_1_v_2_a.RDS")
...
saveRDS(p, file = "Scatterplot Episode Time/cut_self_2_v_3_a.RDS")
...
dz <- data.frame(ep3_time = dx[(dx$cut.self.during.interval.episode == 3), ]$exit,
                 ep4_time = dx[(dx$cut.self.during.interval.episode == 4), ]$exit)
dz <- dz %>% mutate(group = case_when(ep4_time %% 1 == 0 ~ 1, T ~ 2))
dz$ep4_time <- dz$ep4_time - dz$ep3_time
dz$group <- as.factor(dz$group)
p <- dz %>%
  ggplot(aes(ep3_time, ep4_time, shape = group)) +
  scale_shape_manual(values = c(20, 3)) +
...
saveRDS(p, file = "Scatterplot Episode Time/cut_self_3_v_4_a.RDS")
...
dz <- data.frame(ep4_time = dx[(dx$cut.self.during.interval.episode == 4), ]$exit,
                 ep5_time = dx[(dx$cut.self.during.interval.episode == 5), ]$exit)
dz <- dz %>% mutate(group = case_when(ep5_time %% 1 == 0 ~ 1, T ~ 2))
dz$ep5_time <- dz$ep5_time - dz$ep4_time
dz$group <- as.factor(dz$group)
p <- dz %>%
  ggplot(aes(ep4_time, ep5_time, shape = group)) +
  scale_shape_manual(values = c(20, 3)) +
...
saveRDS(p, file = "Scatterplot Episode Time/cut_self_4_v_5_a.RDS")
...
dz <- data.frame(ep5_time = dx[(dx$cut.self.during.interval.episode == 5), ]$exit,
                 ep6_time = dx[(dx$cut.self.during.interval.episode == 6), ]$exit)
dz <- dz %>% mutate(group = case_when(ep6_time %% 1 == 0 ~ 1, T ~ 2))
dz$ep6_time <- dz$ep6_time - dz$ep5_time
dz$group <- as.factor(dz$group)
p <- dz %>%
  ggplot(aes(ep5_time, ep6_time, shape = group)) +
  scale_shape_manual(values = c(20, 3)) +
...
saveRDS(p, file = "Scatterplot Episode Time/cut_self_5_v_6_a.RDS")
...
saveRDS(p, file = "Scatterplot Episode Time/Animal_Attack_1_v_2_a.RDS")
...
saveRDS(p, file = "Scatterplot Episode Time/Animal_Attack_2_v_3_a.RDS")
...
saveRDS(p, file = "Scatterplot Episode Time/Animal_Attack_3_v_4_a.RDS")
...
saveRDS(p, file = "Scatterplot Episode Time/tree_fall_1_v_2_a.RDS")
...
saveRDS(p, file = "Scatterplot Episode Time/tree_fall_2_v_3_a.RDS")
...
saveRDS(p, file = "Scatterplot Episode Time/fight_1_v_2_a.RDS")
...
saveRDS(p, file = "Scatterplot Episode Time/fight_2_v_3_a.RDS")
...
saveRDS(p, file = "Scatterplot Episode Time/canoe_capsize_1_v_2_a.RDS")
...
saveRDS(p, file = "Scatterplot Episode Time/canoe_capsize_2_v_3_a.RDS")


# Panel plots -------------------------------------------------------------

# Sickness
figure <- ggarrange(readRDS("Scatterplot Episode Time/sickness_1_v_2_a.RDS"),
                    readRDS("Scatterplot Episode Time/sickness_2_v_3_a.RDS"))

pdf(file = "Scatterplot Episode Time/panel_sickness_a.pdf", height = 7, width = 15)
annotate_figure(figure, top = textGrob("Sickness", rot = 0, vjust = 0.5, gp = gpar(cex = 5)))
dev.off()

# Cut Self
figure <- ggarrange(readRDS("Scatterplot Episode Time/cut_self_1_v_2_a.RDS"),
                    readRDS("Scatterplot Episode Time/cut_self_2_v_3_a.RDS"),
                    readRDS("Scatterplot Episode Time/cut_self_3_v_4_a.RDS"),
                    readRDS("Scatterplot Episode Time/cut_self_4_v_5_a.RDS"),
                    readRDS("Scatterplot Episode Time/cut_self_5_v_6_a.RDS"))

pdf(file = "Scatterplot Episode Time/panel_cut_self_a.pdf", height = 9, width = 15)
annotate_figure(figure, top = textGrob("Cut Self", rot = 0, vjust = 0.5, gp = gpar(cex = 5)))
dev.off()

# Animal Attack
figure <- ggarrange(readRDS("Scatterplot Episode Time/Animal_Attack_1_v_2_a.RDS"),
                    readRDS("Scatterplot Episode Time/Animal_Attack_2_v_3_a.RDS"),
                    readRDS("Scatterplot Episode Time/Animal_Attack_3_v_4_a.RDS"))

pdf(file = "Scatterplot Episode Time/panel_Animal_Attack_a.pdf", height = 10, width = 12)
annotate_figure(figure, top = textGrob("Animal Attack", rot = 0, vjust = 0.5, gp = gpar(cex = 5)))
dev.off()

# Tree Fall
figure <- ggarrange(readRDS("Scatterplot Episode Time/tree_fall_1_v_2_a.RDS"),
                    readRDS("Scatterplot Episode Time/tree_fall_2_v_3_a.RDS"))

pdf(file = "Scatterplot Episode Time/panel_tree_fall_a.pdf", height = 7, width = 15)
annotate_figure(figure, top = textGrob("Tree Fall", rot = 0, vjust = 0.5, gp = gpar(cex = 5)))
dev.off()

# Fight
figure <- ggarrange(readRDS("Scatterplot Episode Time/fight_1_v_2_a.RDS"),
                    readRDS("Scatterplot Episode Time/fight_2_v_3_a.RDS"))

pdf(file = "Scatterplot Episode Time/panel_fight_a.pdf", height = 7, width = 15)
annotate_figure(figure, top = textGrob("Fight", rot = 0, vjust = 0.5, gp = gpar(cex = 5)))
dev.off()

# Canoe Capsize
figure <- ggarrange(readRDS("Scatterplot Episode Time/canoe_capsize_1_v_2_a.RDS"),
                    readRDS("Scatterplot Episode Time/canoe_capsize_2_v_3_a.RDS"))

pdf(file = "Scatterplot Episode Time/panel_canoe_capsize_a.pdf", height = 7, width = 15)
annotate_figure(figure, top = textGrob("Canoe Capsize", rot = 0, vjust = 0.5, gp = gpar(cex = 5)))
dev.off()
