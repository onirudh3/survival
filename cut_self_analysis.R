...
df_first <- read.csv("cut_self_time_to_first_risk_long_interval.csv") # time to first risk long interval format
...
# Model 1: Sex ------------------------------------------------------------
model1 <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male, data = df)
summary(model1)
...
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model1.tex")

# Model 2: Sex + Risk -----------------------------------------------------

## Model 2a: Sex + Tree Fall ----
model2a <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model2a.tex")

## Model 2b: Sex + Sickness ----
model2b <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model2b.tex")

## Model 2c: Sex + Snake/Ray Bite ----
model2c <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model2c.tex")

## Model 2d: Sex + Animal Attack ----
model2d <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model2d.tex")

## Model 2e: Sex + Fight ----
model2e <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model2e.tex")

## Model 2f: Sex + Canoe Capsize ----
model2f <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model2f.tex")

## Model 2g: Sex + Animal Attack (c) ----
model2g <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model2g.tex")

# Model 3: Sex + Region + Risk --------------------------------------------

## Model 3a: Sex + Region + Tree Fall ----
model3a <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                    tree.fall.during.interval, data = df)
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model3a.tex")
...
model3b <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                    sickness.during.interval, data = df)
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model3b.tex")
...
model3c <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                    bite.during.interval, data = df)
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model3c.tex")
...
model3d <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                    animal.attack.during.interval, data = df)
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model3d.tex")
...
model3e <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                    fought.during.interval, data = df)
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model3e.tex")
...
model3f <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                    canoe.capsize.during.interval, data = df)
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model3f.tex")
...
model3g <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                    Animal_Attack.during.interval, data = df)
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model3g.tex")
...
model4a <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model4a.tex")

## Model 4b: Sex + Region + Sickness + Sex*Sickness ----
model4b <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model4b.tex")

## Model 4c: Sex + Region + Snake/Ray Bite + Sex*Snake/Ray Bite ----
model4c <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model4c.tex")

## Model 4d: Sex + Region + Animal Attack + Sex*Animal Attack ----
model4d <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model4d.tex")

## Model 4e: Sex + Region + Fight + Sex*Fight ----
model4e <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model4e.tex")

## Model 4f: Sex + Region + Canoe Capsize + Sex*Canoe Capsize ----
model4f <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model4f.tex")

## Model 4g: Sex + Region + Animal Attack (c) + Sex*Animal Attack (c) ----
model4g <- coxph(Surv(enter, exit, cut.self.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model4g.tex")
...
model5a <- coxph(Surv(enter, exit, event) ~ length.of.last.cut.self,
                  data = new_df)
...
results <- data.frame(t(results))
results <- results %>% rename("Length of Prior Cut Self Interval" = "t.results.")
results <- round(results, 3)
results <- results %>%
  mutate("No. of Individuals" = c("", "388", ""),
         "No. of Intervals" = c("", "13,451", ""),
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model5a.tex")

## Model 5b: Length of Prior Cut Self + Sex ----
model5b <- coxph(Surv(enter, exit, event) ~ length.of.last.cut.self + male,
                  data = new_df)
...
results <- data.frame(t(results))
results <- results %>% rename("Male" = "male",
                              "Length of Prior Cut Self Interval" = "length.of.last.cut.self")
results <- round(results, 3)
results <- results %>%
  mutate("No. of Individuals" = c("", "388", ""),
         "No. of Intervals" = c("", "13,451", ""),
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model5b.tex")

## Model 5c: Length of Prior Cut Self + Sex + Region ----
model5c <- coxph(Surv(enter, exit, event) ~ length.of.last.cut.self + male +
                    region, data = new_df)
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model5c.tex")

## Model 5d: Length of Prior Cut Self + Tree Fall ----
model5d <- coxph(Surv(enter, exit, event) ~ length.of.last.cut.self +
...
results <- data.frame(t(results))
results <- results %>% rename("Length of Prior Cut Self Interval" = "length.of.last.cut.self",
                              "Tree Fall" = "tree.fall.during.interval")
results <- round(results, 3)
results <- results %>%
  mutate("No. of Individuals" = c("", "388", ""),
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model5d.tex")

## Model 5e: Length of Prior Cut Self + Sickness ----
model5e <- coxph(Surv(enter, exit, event) ~ length.of.last.cut.self +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model5e.tex")

## Model 5f: Length of Prior Cut Self + Snake/Ray Bite ----
model5f <- coxph(Surv(enter, exit, event) ~ length.of.last.cut.self +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model5f.tex")

## Model 5g: Length of Prior Cut Self + Animal Attack ----
model5g <- coxph(Surv(enter, exit, event) ~ length.of.last.cut.self +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model5g.tex")

## Model 5h: Length of Prior Cut Self + Fight ----
model5h <- coxph(Surv(enter, exit, event) ~ length.of.last.cut.self +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model5h.tex")

## Model 5i: Length of Prior Cut Self + Canoe Capsize ----
model5i <- coxph(Surv(enter, exit, event) ~ length.of.last.cut.self +
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model5i.tex")

## Model 5j: Length of Prior Cut Self + Animal Attack (c) ----
model5j <- coxph(Surv(enter, exit, event) ~ length.of.last.cut.self +
...
saveRDS(model6f, file = "Cut Self Tables/coxme_tree_fall.RDS")
...
saveRDS(model6g, file = "Cut Self Tables/coxme_sickness.RDS")
...
saveRDS(model6h, file = "Cut Self Tables/coxme_snake_ray_bite.RDS")
...
saveRDS(model6i, file = "Cut Self Tables/coxme_fight.RDS")
...
saveRDS(model6j, file = "Cut Self Tables/coxme_canoe_capsize.RDS")
...
saveRDS(model6k, file = "Cut Self Tables/coxme_animal_attack_combined.RDS")
...
saveRDS(model6l, file = "Cut Self Tables/coxme_animal_attack.RDS")
...
df_hazard_plot <- bind_rows(cbind(extract_coxme_table(readRDS("Cut Self Tables/coxme_tree_fall.RDS")), data.frame(confint(readRDS("Cut Self Tables/coxme_tree_fall.RDS")))),
                            cbind(extract_coxme_table(readRDS("Cut Self Tables/coxme_sickness.RDS")), data.frame(confint(readRDS("Cut Self Tables/coxme_sickness.RDS")))),
                            cbind(extract_coxme_table(readRDS("Cut Self Tables/coxme_fight.RDS")), data.frame(confint(readRDS("Cut Self Tables/coxme_fight.RDS")))),
                            cbind(extract_coxme_table(readRDS("Cut Self Tables/coxme_animal_attack_combined.RDS")), data.frame(confint(readRDS("Cut Self Tables/coxme_animal_attack_combined.RDS")))),
                            cbind(extract_coxme_table(readRDS("Cut Self Tables/coxme_canoe_capsize.RDS")), data.frame(confint(readRDS("Cut Self Tables/coxme_canoe_capsize.RDS")))))
...
ph_df <- bind_rows(data.frame(cox.zph(readRDS("Cut Self Tables/coxme_tree_fall.RDS"))$table),
                   data.frame(cox.zph(readRDS("Cut Self Tables/coxme_sickness.RDS"))$table),
                   data.frame(cox.zph(readRDS("Cut Self Tables/coxme_fight.RDS"))$table),
                   data.frame(cox.zph(readRDS("Cut Self Tables/coxme_animal_attack_combined.RDS"))$table),
                   data.frame(cox.zph(readRDS("Cut Self Tables/coxme_canoe_capsize.RDS"))$table))
...
pdf(file = "Cut Self Plots/coxme_plot.pdf", height = 6.5, width = 6)
p <- df_hazard_plot %>%
  ggplot() +
...
p
dev.off()
saveRDS(p + labs(x = "", y = "", subtitle = ""), file = "Cut Self Plots/coxme_plot.RDS")
...
## Model 7a: Tree Fall ----
model7a <- coxme(Surv(exit, cut.self.during.interval) ~ strata(male) + strata(year) + (1 | pid) +
                   (1 | house.id) + (1 | region) + tree.fall.during.interval, df_first)
saveRDS(model7a, file = "Cut Self Tables/coxme_tree_fall1.RDS")
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model7a.tex")

# Plot Schoenfeld residuals
pdf(file = "Cut Self Plots/schoenfeld_res1_.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model7a))
dev.off()


## Model 7b: Sickness ----
model7b <- coxme(Surv(exit, cut.self.during.interval) ~ strata(male) + strata(year) + (1 | pid) +
                   (1 | house.id) + (1 | region) + sickness.during.interval, df_first)
saveRDS(model7b, file = "Cut Self Tables/coxme_sickness1.RDS")
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model7b.tex")

# Plot Schoenfeld residuals
pdf(file = "Cut Self Plots/schoenfeld_res2_.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model7b))
dev.off()


## Model 7c: Fight ----
model7c <- coxme(Surv(exit, cut.self.during.interval) ~ strata(male) + strata(year) + (1 | pid) +
                   (1 | house.id) + (1 | region) + fought.during.interval, df_first)
saveRDS(model7c, file = "Cut Self Tables/coxme_fight1.RDS")
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model7c.tex")

# Plot Schoenfeld residuals
pdf(file = "Cut Self Plots/schoenfeld_res3_.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model7c))
dev.off()


## Model 7d: Canoe Capsize ---- ERROR :D
# model7d <- coxme(Surv(exit, cut.self.during.interval) ~ strata(male) + strata(year) + (1 | pid) +
#                    (1 | house.id) + (1 | region) + canoe.capsize.during.interval, df_first)
# saveRDS(model7d, file = "Cut Self Tables/coxme_canoe_capsize1.RDS")
#
...
# x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
# align(x) <- "lcccccc"
# print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model7d.tex")
#
# # Plot Schoenfeld residuals
# pdf(file = "Cut Self Plots/schoenfeld_res4_.pdf", height = 5, width = 7)
# ggcoxzph(cox.zph(model7d))
# dev.off()


## Model 7e: Animal Attack (c) ----
model7e <- coxme(Surv(exit, cut.self.during.interval) ~ strata(male) + strata(year) + (1 | pid) +
                   (1 | house.id) + (1 | region) + Animal_Attack.during.interval, df_first)
saveRDS(model7e, file = "Cut Self Tables/coxme_animal_attack_combined1.RDS")
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model7e.tex")

# Plot Schoenfeld residuals
pdf(file = "Cut Self Plots/schoenfeld_res5_.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model7e))
dev.off()

# Building mixed effects hazard plot for all risks ------------------------

df_hazard_plot <- bind_rows(cbind(extract_coxme_table(readRDS("Cut Self Tables/coxme_tree_fall1.RDS")), data.frame(confint(readRDS("Cut Self Tables/coxme_tree_fall1.RDS")))),
                            cbind(extract_coxme_table(readRDS("Cut Self Tables/coxme_sickness1.RDS")), data.frame(confint(readRDS("Cut Self Tables/coxme_sickness1.RDS")))),
                            cbind(extract_coxme_table(readRDS("Cut Self Tables/coxme_fight1.RDS")), data.frame(confint(readRDS("Cut Self Tables/coxme_fight1.RDS")))),
                            cbind(extract_coxme_table(readRDS("Cut Self Tables/coxme_animal_attack_combined1.RDS")), data.frame(confint(readRDS("Cut Self Tables/coxme_animal_attack_combined1.RDS")))))
...
ph_df <- bind_rows(data.frame(cox.zph(readRDS("Cut Self Tables/coxme_tree_fall1.RDS"))$table),
                   data.frame(cox.zph(readRDS("Cut Self Tables/coxme_sickness1.RDS"))$table),
                   data.frame(cox.zph(readRDS("Cut Self Tables/coxme_fight1.RDS"))$table),
                   data.frame(cox.zph(readRDS("Cut Self Tables/coxme_animal_attack_combined1.RDS"))$table))
ph_df <- ph_df %>% filter(!duplicated(ph_df))
ph_df <- rownames_to_column(ph_df, "covariate")
...
pdf(file = "Cut Self Plots/coxme_plot_.pdf", height = 6.5, width = 6)
p <- df_hazard_plot %>%
  ggplot() +
  geom_bar(aes(x = reorder(covariate, -exp_beta), y = exp_beta, fill = p.y), stat = "identity") +
  geom_errorbar(aes(x = covariate, ymin = X2.5.., ymax = X97.5..), width = 0.5, size = 0.4) +
...
p
dev.off()
saveRDS(p + labs(x = "", y = "", subtitle = ""), file = "Cut Self Plots/coxme_plot_.RDS")
...
model8 <- coxme(Surv(exit, cut.self.during.interval) ~ strata(male) + centered.year + (1 | pid) +
                  (1 | house.id) + (1 | region), df_first)
saveRDS(model8, file = "Cut Self Tables/coxme_calendar_year.RDS")
...
x <- xtable(results, caption = "Cut Self \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Cut Self Tables/model8.tex")

# Plot Schoenfeld residuals
pdf(file = "Cut Self Plots/schoenfeld_res_calendar_year.pdf", height = 5, width = 7)
...
df %>%
  ...
  ggplot() +
  geom_col(aes(x = age.cat, y = prop), fill = "orange") +
...
stargazer(gg, summary = F, out = "Cut Self Tables/risk_table.tex",
...
df_surv <- df_surv %>% rename("Age (Years)" = "time",
                              ...
                              "Lower CI" = "lower.ci",
                              "Upper CI" = "upper.ci")
stargazer(df_surv, summary = F, out = "Cut Self Tables/hazard_table.tex",
          title = "Cut Self \\vspace{-1.4em}", rownames = F,
          notes = "\\tiny Note: Cut Self hazard begins from the age interval 2-3 onward.")
