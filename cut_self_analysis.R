...
stargazer(model1, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
...
summary(model2a)
stargazer(model2a, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
summary(model2b)
stargazer(model2b, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
summary(model2c)
stargazer(model2c, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
summary(model2d)
stargazer(model2d, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
summary(model2e)
stargazer(model2e, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
summary(model2f)
stargazer(model2f, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
summary(model2g)
stargazer(model2g, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model3a <- coxreg(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                    tree.fall.during.interval, data = df)
summary(model3a)
stargazer(model3a, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model3b <- coxreg(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                    sickness.during.interval, data = df)
summary(model3b)
stargazer(model3b, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model3c <- coxreg(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                    bite.during.interval, data = df)
summary(model3c)
stargazer(model3c, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
stargazer(model3d, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model3e <- coxreg(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                    fought.during.interval, data = df)
summary(model3e)
stargazer(model3e, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model3f <- coxreg(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                    canoe.capsize.during.interval, data = df)
summary(model3f)
stargazer(model3f, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model3g <- coxreg(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                    Animal_Attack.during.interval, data = df)
summary(model3g)
stargazer(model3g, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
summary(model4a)
stargazer(model4a, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model4b <- coxreg(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                  ...
                  data = df)
summary(model4b)
stargazer(model4b, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model4c <- coxreg(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                  ...
                  data = df)
summary(model4c)
stargazer(model4c, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model4d <- coxreg(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                  ...
                  data = df)
summary(model4d)
stargazer(model4d, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model4e <- coxreg(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                  ...
                  data = df)
summary(model4e)
stargazer(model4e, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model4f <- coxreg(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                  ...
                  data = df)
summary(model4f)
stargazer(model4f, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model4g <- coxreg(Surv(enter, exit, cut.self.during.interval) ~ male + region +
                  ...
                  data = df)
summary(model4g)
stargazer(model4g, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model5a <- coxreg(Surv(enter, exit, event) ~ length.of.last.cut.self,
                  data = new_df)
summary(model5a)
stargazer(model5a, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model5b <- coxreg(Surv(enter, exit, event) ~ length.of.last.cut.self + male,
                  data = new_df)
summary(model5b)
stargazer(model5b, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
model5c <- coxreg(Surv(enter, exit, event) ~ length.of.last.cut.self + male +
                    region, data = new_df)
summary(model5c)
stargazer(model5c, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
summary(model5d)
stargazer(model5d, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
summary(model5e)
stargazer(model5e, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
summary(model5f)
stargazer(model5f, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
summary(model5g)
stargazer(model5g, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
summary(model5h)
stargazer(model5h, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
summary(model5i)
stargazer(model5i, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
summary(model5j)
stargazer(model5j, type = "latex", report = "vcsp", single.row = T, title = "Cut Self \\vspace{-1.4em}",
          notes = "Standard errors in parentheses",
...
addtorow$command <- c('\\hline',
                      ...
                      '\\hline')
print(xtable(df_coxme, caption = "Cut Self Mixed Effects Specifications"), add.to.row = addtorow,
      caption.placement = "top", file = "Cut Self Tables/model6.tex")
...
# Survival risk table
fit <- survfit(Surv(enter, exit, cut.self.during.interval) ~ 1, df_first)
