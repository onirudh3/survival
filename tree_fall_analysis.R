...
df_first <- read.csv("tree_fall_time_to_first_risk_long_interval.csv") # time to first risk long interval format
...
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model1.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model2a.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model2b.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model2c.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model2d.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model2e.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model2f.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model2g.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model3a.tex")

# Plot
pdf(file = "Tree Fall Plots/model3a.pdf", height = 5, width = 5)
plot(coxreg(Surv(enter, exit, tree.fall.during.interval) ~ male + region +
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model3b.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model3c.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model3d.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model3e.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model3f.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model3g.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model4a.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model4b.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model4c.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model4d.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model4e.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model4f.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model4g.tex")


# Model 5: Sex + Region + Length of Last Fight + Risk ------------------

# Create new df with no NAs in length.of.last.tree.fall
new_df <- df_long %>%
  tidyr::drop_na(length.of.last.tree.fall)
...
results <- data.frame(t(results))
results <- results %>% rename("Length of Prior Tree Fall Interval" = "t.results.")
results <- round(results, 3)
results <- results %>%
  mutate("No. of Individuals" = c("", "388", ""),
         "No. of Intervals" = c("", "13,451", ""),
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model5a.tex")
...
results <- data.frame(t(results))
results <- results %>% rename("Male" = "male",
                              "Length of Prior Tree Fall Interval" = "length.of.last.tree.fall")
results <- round(results, 3)
results <- results %>%
  mutate("No. of Individuals" = c("", "388", ""),
         "No. of Intervals" = c("", "13,451", ""),
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model5b.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model5c.tex")
...
results <- data.frame(t(results))
results <- results %>% rename("Length of Prior Tree Fall Interval" = "length.of.last.tree.fall",
                              "Fight" = "fought.during.interval")
results <- round(results, 3)
results <- results %>%
  mutate("No. of Individuals" = c("", "388", ""),
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model5d.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model5e.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model5f.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model5g.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model5h.tex")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model5i.tex")

## Model 5j: Length of Prior Tree Fall + Animal Attack (c) ----
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model5j.tex")
...
saveRDS(model6f, file = "Tree Fall Tables/coxme_sickness.RDS")
...
saveRDS(model6g, file = "Tree Fall Tables/coxme_snake_ray_bite.RDS")
...
saveRDS(model6h, file = "Tree Fall Tables/coxme_fight.RDS")
...
saveRDS(model6i, file = "Tree Fall Tables/coxme_canoe_capsize.RDS")
...
saveRDS(model6j, file = "Tree Fall Tables/coxme_animal_attack.RDS")
...
saveRDS(model6k, file = "Tree Fall Tables/coxme_animal_attack_combined.RDS")
...
saveRDS(model6l, file = "Tree Fall Tables/coxme_cut_self.RDS")
...
df_hazard_plot <- bind_rows(cbind(extract_coxme_table(readRDS("Tree Fall Tables/coxme_fight.RDS")), data.frame(confint(readRDS("Tree Fall Tables/coxme_fight.RDS")))),
                            cbind(extract_coxme_table(readRDS("Tree Fall Tables/coxme_sickness.RDS")), data.frame(confint(readRDS("Tree Fall Tables/coxme_sickness.RDS")))),
                            # cbind(extract_coxme_table(readRDS("Tree Fall Tables/coxme_animal_attack.RDS")), data.frame(confint(readRDS("Tree Fall Tables/coxme_animal_attack.RDS")))),
                            cbind(extract_coxme_table(readRDS("Tree Fall Tables/coxme_animal_attack_combined.RDS")), data.frame(confint(readRDS("Tree Fall Tables/coxme_animal_attack_combined.RDS")))),
                            cbind(extract_coxme_table(readRDS("Tree Fall Tables/coxme_cut_self.RDS")), data.frame(confint(readRDS("Tree Fall Tables/coxme_cut_self.RDS")))),
                            cbind(extract_coxme_table(readRDS("Tree Fall Tables/coxme_canoe_capsize.RDS")), data.frame(confint(readRDS("Tree Fall Tables/coxme_canoe_capsize.RDS")))))
...
ph_df <- bind_rows(data.frame(cox.zph(readRDS("Tree Fall Tables/coxme_fight.RDS"))$table),
                   data.frame(cox.zph(readRDS("Tree Fall Tables/coxme_sickness.RDS"))$table),
                   data.frame(cox.zph(readRDS("Tree Fall Tables/coxme_animal_attack_combined.RDS"))$table),
                   data.frame(cox.zph(readRDS("Tree Fall Tables/coxme_cut_self.RDS"))$table),
                   data.frame(cox.zph(readRDS("Tree Fall Tables/coxme_canoe_capsize.RDS"))$table))
...
model7a <- coxme(Surv(exit, tree.fall.during.interval) ~ strata(male) + strata(year) + (1 | pid) +
                   (1 | house.id) + (1 | region) + sickness.during.interval, df_first)
saveRDS(model7a, file = "Tree Fall Tables/coxme_sickness1.RDS")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model7a.tex")

# Plot Schoenfeld residuals
pdf(file = "Tree Fall Plots/schoenfeld_res1_.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model7a))
dev.off()


## Model 7b: Fight ----
model7b <- coxme(Surv(exit, tree.fall.during.interval) ~ strata(male) + strata(year) + (1 | pid) +
                   (1 | house.id) + (1 | region) + fought.during.interval, df_first)
saveRDS(model7b, file = "Tree Fall Tables/coxme_fight1.RDS")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model7b.tex")

# Plot Schoenfeld residuals
pdf(file = "Tree Fall Plots/schoenfeld_res2_.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model7b))
dev.off()


## Model 7c: Canoe Capsize ----
model7c <- coxme(Surv(exit, tree.fall.during.interval) ~ strata(male) + strata(year) + (1 | pid) +
                   (1 | house.id) + (1 | region) + canoe.capsize.during.interval, df_first)
saveRDS(model7c, file = "Tree Fall Tables/coxme_canoe_capsize1.RDS")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model7c.tex")

# Plot Schoenfeld residuals
pdf(file = "Tree Fall Plots/schoenfeld_res3_.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model7c))
dev.off()

## Model 7d: Animal Attack (c) ----
model7d <- coxme(Surv(exit, tree.fall.during.interval) ~ strata(male) + strata(year) + (1 | pid) +
                   (1 | house.id) + (1 | region) + Animal_Attack.during.interval, df_first)
saveRDS(model7d, file = "Tree Fall Tables/coxme_animal_attack_combined1.RDS")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model7d.tex")

# Plot Schoenfeld residuals
pdf(file = "Tree Fall Plots/schoenfeld_res5_.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model7d))
dev.off()


## Model 7e: Cut Self ----
model7e <- coxme(Surv(exit, tree.fall.during.interval) ~ strata(male) + strata(year) + (1 | pid) +
                   (1 | house.id) + (1 | region) + cut.self.during.interval, df_first)
saveRDS(model7e, file = "Tree Fall Tables/coxme_cut_self1.RDS")
...
x <- xtable(results, caption = "Tree Fall \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Tree Fall Tables/model7e.tex")

# Plot Schoenfeld residuals
pdf(file = "Tree Fall Plots/schoenfeld_res6_.pdf", height = 5, width = 7)
...
df_hazard_plot <- bind_rows(cbind(extract_coxme_table(readRDS("Tree Fall Tables/coxme_fight1.RDS")), data.frame(confint(readRDS("Tree Fall Tables/coxme_fight.RDS")))),
                            cbind(extract_coxme_table(readRDS("Tree Fall Tables/coxme_sickness1.RDS")), data.frame(confint(readRDS("Tree Fall Tables/coxme_sickness.RDS")))),
                            # cbind(extract_coxme_table(readRDS("Tree Fall Tables/coxme_animal_attack.RDS")), data.frame(confint(readRDS("Tree Fall Tables/coxme_animal_attack.RDS")))),
                            cbind(extract_coxme_table(readRDS("Tree Fall Tables/coxme_animal_attack_combined1.RDS")), data.frame(confint(readRDS("Tree Fall Tables/coxme_animal_attack_combined.RDS")))),
                            cbind(extract_coxme_table(readRDS("Tree Fall Tables/coxme_cut_self1.RDS")), data.frame(confint(readRDS("Tree Fall Tables/coxme_cut_self.RDS")))),
                            cbind(extract_coxme_table(readRDS("Tree Fall Tables/coxme_canoe_capsize1.RDS")), data.frame(confint(readRDS("Tree Fall Tables/coxme_canoe_capsize.RDS")))))
...
ph_df <- bind_rows(data.frame(cox.zph(readRDS("Tree Fall Tables/coxme_fight1.RDS"))$table),
                   data.frame(cox.zph(readRDS("Tree Fall Tables/coxme_sickness1.RDS"))$table),
                   data.frame(cox.zph(readRDS("Tree Fall Tables/coxme_animal_attack_combined1.RDS"))$table),
                   data.frame(cox.zph(readRDS("Tree Fall Tables/coxme_cut_self1.RDS"))$table),
                   data.frame(cox.zph(readRDS("Tree Fall Tables/coxme_canoe_capsize1.RDS"))$table))
ph_df <- ph_df %>% filter(!duplicated(ph_df))
ph_df <- rownames_to_column(ph_df, "covariate")
...
pdf(file = "Tree Fall Plots/coxme_plot_.pdf", height = 6.5, width = 6)
p <- df_hazard_plot %>%
  ggplot() +
  geom_bar(aes(x = reorder(covariate, -exp_beta), y = exp_beta, fill = p.y), stat = "identity") +
  geom_errorbar(aes(x = covariate, ymin = X2.5.., ymax = X97.5..), width = 0.5, size = 0.4) +
...
model8 <- coxme(Surv(exit, tree.fall.during.interval) ~ strata(male) + centered.year + (1 | pid) +
...
## Percentage of intervals where Tree fall occurred by age category ----
# Bar plot
pdf(file = "Tree Fall Plots/descriptive_plot1.pdf", height = 5,
    width = 7)
df %>%
  ...
  ggplot() +
  geom_col(aes(x = age.cat, y = prop), fill = "lightgreen") +
...
# Line plot
pdf(file = "Tree Fall Plots/descriptive_plot2.pdf", height = 5, width = 7)
df %>%
  count(age.cat, tree.fall.during.interval) %>%
  mutate(prop = prop.table(n)) %>%
  filter(tree.fall.during.interval == 1) %>%
  ggplot() +
  geom_line(aes(x = age.cat, y = prop, group = 1), color = "lightgreen",
            linewidth = 2) +
  geom_text(aes(x = age.cat, y = prop,
...
pdf(file = "Tree Fall Plots/descriptive_plot3.pdf", height = 5, width = 7.5)
...
### Fight ----
# Distribution of co-occurring fight within tree fall age intervals
pdf(file = "Tree Fall Plots/co_occurrence1a.pdf", height = 5, width = 7)
df_long %>%
  count(fought.co_occurrence.interval) %>%
  mutate(prop = prop.table(n)) %>%
  filter(!is.na(fought.co_occurrence.interval)) %>%
  ggplot() +
  geom_col(aes(x = fought.co_occurrence.interval, y = prop),
           fill = "#7c9b99", width = 0.9, show.legend = F) +
  geom_text(aes(x = fought.co_occurrence.interval, y = prop,
                label = scales::percent(prop)), vjust = 0, nudge_y = .001,
            size = 4) +
  scale_y_continuous(labels = scales::percent) +
  theme_classic(base_size = 15) +
  ggtitle("TREE FALL and FIGHT") +
  theme(plot.title = element_text(size = 25)) +
  xlab("Age of Co-occurrence") +
  ylab("Percentage of Intervals") + labs(subtitle = "388 Individuals, 568 Intervals")
dev.off()

# By gender
pdf(file = "Tree Fall Plots/co_occurrence1b.pdf", height = 5, width = 10)
df_long %>%
  count(fought.co_occurrence.interval, male) %>%
  mutate(prop = prop.table(n)) %>%
  filter(!is.na(fought.co_occurrence.interval)) %>%
  ggplot() +
  geom_col(aes(x = fought.co_occurrence.interval, y = prop, fill = male),
...
pdf(file = "Tree Fall Plots/co_occurrence2a.pdf", height = 5, width = 7)
df_long %>%
...
# By gender
pdf(file = "Tree Fall Plots/co_occurrence2b.pdf", height = 5, width = 10)
df_long %>%
...
pdf(file = "Tree Fall Plots/co_occurrence3a.pdf", height = 5, width = 7)
df_long %>%
...
# By gender
pdf(file = "Tree Fall Plots/co_occurrence3b.pdf", height = 5, width = 10)
df_long %>%
...
pdf(file = "Tree Fall Plots/co_occurrence4a.pdf", height = 5, width = 7.5)
df_long %>%
...
# By gender
pdf(file = "Tree Fall Plots/co_occurrence4b.pdf", height = 5, width = 10)
df_long %>%
...
pdf(file = "Tree Fall Plots/co_occurrence5a.pdf", height = 5, width = 7.5)
df_long %>%
...
# By gender
pdf(file = "Tree Fall Plots/co_occurrence5b.pdf", height = 5, width = 10)
df_long %>%
...
pdf(file = "Tree Fall Plots/co_occurrence6a.pdf", height = 5, width = 7)
df_long %>%
...
# By gender
pdf(file = "Tree Fall Plots/co_occurrence6b.pdf", height = 5, width = 10)
df_long %>%
...
### Animal Attack (c) ----
# Distribution of co-occurring Animal Attack (c) within tree fall age intervals
pdf(file = "Tree Fall Plots/co_occurrence7a.pdf", height = 5, width = 7)
df_long %>%
  ...
  scale_y_continuous(labels = scales::percent) +
  theme_classic(base_size = 15) +
  ggtitle("TREE FALL and ANIMAL ATTACK (c)") +
  theme(plot.title = element_text(size = 25)) +
  xlab("Age of Co-occurrence") +
  ylab("Percentage of Intervals") + labs(subtitle = "388 Individuals, 568 Intervals")
dev.off()
...
# By gender
pdf(file = "Tree Fall Plots/co_occurrence7b.pdf", height = 5, width = 10)
df_long %>%
...
df_long$event <- ifelse(df_long$event == 1, "Tree Fall
Occurred", "Tree Fall Did
Not Occur")
...
pdf(file = "Tree Fall Plots/co_occurrence1c.pdf", height = 4, width = 6.5)
df_long %>%
...
pdf(file = "Tree Fall Plots/co_occurrence1d.pdf", height = 4, width = 7)
df_long %>%
...
# By region
pdf(file = "Tree Fall Plots/co_occurrence1e.pdf", height = 4.5, width = 7)
df_long %>%
...
pdf(file = "Tree Fall Plots/co_occurrence2c.pdf", height = 4, width = 6.5)
df_long %>%
...
# For males and females
pdf(file = "Tree Fall Plots/co_occurrence2d.pdf", height = 4, width = 7)
df_long %>%
...
# By region
pdf(file = "Tree Fall Plots/co_occurrence2f.pdf", height = 4, width = 7.5)
df_long %>%
...
pdf(file = "Tree Fall Plots/co_occurrence3c.pdf", height = 4, width = 6)
df_long %>%
...
# For males and females
pdf(file = "Tree Fall Plots/co_occurrence3d.pdf", height = 4, width = 7)
df_long %>%
...
# By region
pdf(file = "Tree Fall Plots/co_occurrence3e.pdf", height = 4, width = 7)
df_long %>%
...
pdf(file = "Tree Fall Plots/co_occurrence4c.pdf", height = 4, width = 6)
df_long %>%
...
# For males and females
pdf(file = "Tree Fall Plots/co_occurrence4d.pdf", height = 4, width = 7.5)
df_long %>%
...
# By region
pdf(file = "Tree Fall Plots/co_occurrence4e.pdf", height = 4.5, width = 7)
df_long %>%
...
pdf(file = "Tree Fall Plots/co_occurrence5c.pdf", height = 4, width = 6)
df_long %>%
...
# For males and females
pdf(file = "Tree Fall Plots/co_occurrence5d.pdf", height = 4, width = 8)
df_long %>%
...
# By region
pdf(file = "Tree Fall Plots/co_occurrence5e.pdf", height = 4.5, width = 7.5)
df_long %>%
...
pdf(file = "Tree Fall Plots/co_occurrence6c.pdf", height = 4, width = 6)
df_long %>%
...
# For males and females
pdf(file = "Tree Fall Plots/co_occurrence6d.pdf", height = 4, width = 7)
df_long %>%
...
# By region
pdf(file = "Tree Fall Plots/co_occurrence6e.pdf", height = 4.5, width = 7)
df_long %>%
...
pdf(file = "Tree Fall Plots/co_occurrence7c.pdf", height = 4, width = 6)
df_long %>%
...
# For males and females
pdf(file = "Tree Fall Plots/co_occurrence7d.pdf", height = 4, width = 7)
df_long %>%
...
# By region
pdf(file = "Tree Fall Plots/co_occurrence7e.pdf", height = 4.5, width = 7)
df_long %>%
...
## Survival Function ----
fit <- survfit(Surv(enter, exit, tree.fall.during.interval) ~ 1, data = df)
pdf(file = "Tree Fall Plots/survival_function.pdf", height = 5, width = 6)
autoplot(fit, censor.shape = '|', censor.colour = "lightgreen",
         surv.colour = "lightgreen") +
...
# Survival risk table
df_event <- subset(df_first, event == 1) # Tree fall occurred 183 times
...
## Hazard Function ----
### bshazard ----
fit <- bshazard(Surv(enter, exit, tree.fall.during.interval) ~ 1, data = df)
# plot(fit)
df_surv <- data.frame(time = fit$time, hazard = fit$hazard,
                      lower.ci = fit$lower.ci, upper.ci = fit$upper.ci)
pdf(file = "Tree Fall Plots/hazard_function1.pdf", height = 5)
...
df_surv <- data.frame(time = fit$time, hazard = fit$hazard,
                      lower.ci = fit$lower.ci, upper.ci = fit$upper.ci)
df_surv <- round(df_surv, 3) # here we understand hazards begin from age 5 onward
...
df_surv <- df_surv %>% rename("Age (Years)" = "time",
                    ...
                    "Lower CI" = "lower.ci",
                    "Upper CI" = "upper.ci")
stargazer(df_surv, summary = F, out = "Tree Fall Tables/hazard_table.tex",
          title = "Tree Fall \\vspace{-1.4em}", rownames = F,
          notes = "\\tiny Note: Tree fall hazard begins from the age interval 4-5 onward.")

### muhaz ----
pdf(file = "Tree Fall Plots/hazard_function2.pdf", height = 5)
mfit <- muhaz(df$exit, df$tree.fall.during.interval)
plot(mfit, main = "TREE FALL")
dev.off()

# plot(muhaz2(Surv(exit, tree.fall.during.interval) ~ 1, data = df))

pdf(file = "Tree Fall Plots/hazard_function3.pdf", height = 5)
kfit <- kphaz.fit(df$exit, df$tree.fall.during.interval)
kphaz.plot(kfit, main = "TREE FALL")
dev.off()

# pfit <- pehaz(df$exit, df$tree.fall.during.interval)
# plot(pfit)

### By gender ----
fit <- bshazard(Surv(enter, exit, tree.fall.during.interval) ~ 1, data = subset(df, male == "Male"))
summary(fit)
df_surv <- data.frame(time = fit$time, hazard = fit$hazard,
                      lower.ci = fit$lower.ci, upper.ci = fit$upper.ci)
df_surv$Sex <- "Male"

fit2 <- bshazard(Surv(enter, exit, tree.fall.during.interval) ~ 1, data = subset(df, male == "Female"))
summary(fit2)
...
pdf(file = "Tree Fall Plots/hazard_function4.pdf", height = 5)
...
pdf(file = "Tree Fall Plots/hazard_function5.pdf", height = 5)
ggplot(df_surv4) +
...
### Hazard function for ages 0-15, ages 15+ plot ----
df_young <- subset(df, df$age <= 15)
plyr::count(df_young$pid) # 10 Individuals

fit <- bshazard(Surv(enter, exit, tree.fall.during.interval) ~ 1,
                data = df_young)
df_surv <- data.frame(time = fit$time, hazard = fit$hazard,
                      lower.ci = fit$lower.ci, upper.ci = fit$upper.ci)

df_old <- subset(df, df$age > 15)
plyr::count(df_old$pid) # 378 Individuals

fit2 <- bshazard(Surv(enter, exit, tree.fall.during.interval) ~ 1, data = df_old)
df_surv2 <- data.frame(time = fit2$time, hazard = fit2$hazard,
                       lower.ci = fit2$lower.ci, upper.ci = fit2$upper.ci)

pdf(file = "Tree Fall Plots/hazard_function6.pdf", height = 5)
ggplot() +
  geom_ribbon(data = df_surv2, aes(x = time, ymin = lower.ci, ymax = upper.ci, fill = "Age 15+ (378 Individuals, 13,312 Intervals)"), alpha = 0.2, fill = "turquoise") +
  geom_ribbon(data = df_surv, aes(x = time, ymin = lower.ci, ymax = upper.ci, fill = "Age 0-15 (10 Individuals, 139 Intervals)"), alpha = 0.2, fill = "magenta") +
  geom_line(data = df_surv2, aes(x = time, y = hazard, color = "Age 15+ (378 Individuals, 13,312 Intervals)")) +
  geom_line(data = df_surv, aes(x = time, y = hazard, color = "Age 0-15 (10 Individuals, 139 Intervals)")) +
  ggtitle("Tree Fall") +
  theme(plot.title = element_text(size = 30)) +
  labs(subtitle = "388 Total Individuals, 13,451 Total Intervals") +
  theme_classic(base_size = 14) +
  theme(plot.title = element_text(size = 30)) +
  xlab("Age in Years") +
  ylab("Probability of experiencing risk") +
  scale_color_manual(values = c("Age 15+ (378 Individuals, 13,312 Intervals)" = "turquoise", "Age 0-15 (10 Individuals, 139 Intervals)" = "magenta")) +
  theme(legend.title = element_blank(), legend.position = c(0.7, 0.5)) +
  scale_x_continuous(breaks = seq(0, 100, 5), expand = c(0, 0), limits = c(0, NA)) +
  scale_y_continuous(expand = c(0, 0), limits = c(0, NA))
dev.off()
...
fit <- survfit(Surv(enter, exit, tree.fall.during.interval) ~ 1, data = df)
pdf(file = "Tree Fall Plots/cumhaz_plot1.pdf", height = 5)
autoplot(fit, censor.shape = '|', censor.colour = "lightgreen",
...
# By gender
fit2 <- survfit(Surv(enter, exit, tree.fall.during.interval) ~ male, data = df)
pdf(file = "Tree Fall Plots/cumhaz_plot2.pdf", height = 5)
ggsurvplot(fit2, font.title = c("30"), conf.int = TRUE, legend = "right",
           legend.labs = c("Female", "Male"),
           legend.title = "Sex", palette = c("orchid2", "dodgerblue2"),
           title = "Tree Fall", fun = "cumhaz", axes.offset = F, break.x.by = 5,
