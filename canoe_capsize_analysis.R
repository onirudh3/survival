...
# Sex + region ------------------------------------------------------------
# PH not violated for region
model5 <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + region +
                  (1 | pid), df)
...
# Tree Fall
model5a <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + region +
                   tree.fall.during.interval + (1 | pid), df)
saveRDS(model5a, file = "Canoe Capsize Tables/region_tree_fall_1.RDS")
...
# Sickness
model5b <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + region +
                   sickness.during.interval + (1 | pid), df)
saveRDS(model5b, file = "Canoe Capsize Tables/region_sickness_1.RDS")
...
# Animal Attack
model5c <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + region +
                   Animal_Attack.during.interval + (1 | pid), df)
saveRDS(model5c, file = "Canoe Capsize Tables/region_Animal_Attack_1.RDS")
...
# Cut Self
model5d <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + region +
                   cut.self.during.interval + (1 | pid), df)
saveRDS(model5d, file = "Canoe Capsize Tables/region_cut_self_1.RDS")
...
# Fight
model5e <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + region +
                   fought.during.interval + (1 | pid), df)
saveRDS(model5e, file = "Canoe Capsize Tables/region_fight_1.RDS")
...
# Tree Fall
model6a <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + region + strata(tercile) +
                   tree.fall.during.interval + (1 | pid), df)
saveRDS(model6a, file = "Canoe Capsize Tables/tercile_tree_fall_1.RDS")
...
# Sickness
model6b <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + region + strata(tercile) +
                   sickness.during.interval + (1 | pid), df)
saveRDS(model6b, file = "Canoe Capsize Tables/tercile_sickness_1.RDS")
...
# Animal Attack
model6c <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + region + strata(tercile) +
                   Animal_Attack.during.interval + (1 | pid), df)
saveRDS(model6c, file = "Canoe Capsize Tables/tercile_Animal_Attack_1.RDS")
...
# Cut Self
model6d <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + region + strata(tercile) +
                   cut.self.during.interval + (1 | pid), df)
saveRDS(model6d, file = "Canoe Capsize Tables/tercile_cut_self_1.RDS")
...
# Fight
model6e <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + region + strata(tercile) +
                   fought.during.interval + (1 | pid), df)
saveRDS(model6e, file = "Canoe Capsize Tables/tercile_fight_1.RDS")
