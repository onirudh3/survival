...
# eha::logrank(Surv(enter, exit, canoe.capsize.during.interval), group = tercile, data = df)
# plot(survfit(Surv(enter, exit, canoe.capsize.during.interval) ~ tercile, df))
...
plot(coxreg(Surv(enter, exit, canoe.capsize.during.interval) ~ male + region +
              strata(tree.fall.during.interval), data = df),
     main = "Canoe Capsize (Controlling for Sex and Region)",
     xlab = "Age in Years",
...
# Create new df with no NAs in length.of.last.canoe.capsize
new_df <- df_long %>%
  tidyr::drop_na(length.of.last.canoe.capsize)
...
c <- eha::logrank(Surv(exit, canoe.capsize.during.interval), male, df_first)
c <- data.frame("Chisq" = c$test.statistic, "df" = c$df, "p" = c$p.value)
stargazer(c, summary = F, title = "Canoe Capsize Log-rank Test Results for Sex", rownames = F,
          out = "Canoe Capsize Tables/logranktest3.tex")

d <- eha::logrank(Surv(exit, canoe.capsize.during.interval), region, df_first)
d <- data.frame("Chisq" = d$test.statistic, "df" = d$df, "p" = d$p.value)
stargazer(d, summary = F, title = "Canoe Capsize Log-rank Test Results for Region", rownames = F,
          out = "Canoe Capsize Tables/logranktest4.tex")
...
## Model 6f: Tree Fall ----
model6f <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + (1 | pid) +
                   (1 | house.id) + (1 | region) + tree.fall.during.interval, df_first)
saveRDS(model6f, file = "Canoe Capsize Tables/coxme_tree_fall.RDS")
...
x <- xtable(results, caption = "Canoe Capsize \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Canoe Capsize Tables/model6f.tex")

# Plot Schoenfeld residuals
pdf(file = "Canoe Capsize Plots/schoenfeld_res1.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6f))
dev.off()


## Model 6g: Sickness ----
model6g <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + (1 | pid) +
                   (1 | house.id) + (1 | region) + sickness.during.interval, df_first)
saveRDS(model6g, file = "Canoe Capsize Tables/coxme_sickness.RDS")
...
x <- xtable(results, caption = "Canoe Capsize \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Canoe Capsize Tables/model6g.tex")

# Plot Schoenfeld residuals
pdf(file = "Canoe Capsize Plots/schoenfeld_res2.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6g))
dev.off()


## Model 6h: Snake/Ray Bite ----
model6h <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + (1 | pid) +
                   (1 | house.id) + (1 | region) + bite.during.interval, df_first)
saveRDS(model6h, file = "Canoe Capsize Tables/coxme_snake_ray_bite.RDS")
...
x <- xtable(results, caption = "Canoe Capsize \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Canoe Capsize Tables/model6h.tex")

# Plot Schoenfeld residuals
pdf(file = "Canoe Capsize Plots/schoenfeld_res3.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6h))
dev.off()


## Model 6i: Fight ----
model6i <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + (1 | pid) +
                   (1 | house.id) + (1 | region) + fought.during.interval, df_first)
saveRDS(model6i, file = "Canoe Capsize Tables/coxme_fight.RDS")
...
x <- xtable(results, caption = "Canoe Capsize \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Canoe Capsize Tables/model6i.tex")

# Plot Schoenfeld residuals
pdf(file = "Canoe Capsize Plots/schoenfeld_res4.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6i))
dev.off()


## Model 6j: Animal Attack ----
model6j <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + (1 | pid) +
                   (1 | house.id) + (1 | region) + animal.attack.during.interval, df_first)
saveRDS(model6j, file = "Canoe Capsize Tables/coxme_animal_attack.RDS")
...
x <- xtable(results, caption = "Canoe Capsize \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Canoe Capsize Tables/model6j.tex")

# Plot Schoenfeld residuals
pdf(file = "Canoe Capsize Plots/schoenfeld_res5.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6j))
dev.off()


## Model 6k: Animal Attack (c) ----
model6k <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + (1 | pid) +
                   (1 | house.id) + (1 | region) + Animal_Attack.during.interval, df_first)
saveRDS(model6k, file = "Canoe Capsize Tables/coxme_animal_attack_combined.RDS")
...
x <- xtable(results, caption = "Canoe Capsize \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Canoe Capsize Tables/model6k.tex")

# Plot Schoenfeld residuals
pdf(file = "Canoe Capsize Plots/schoenfeld_res6.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6k))
dev.off()


## Model 6l: Cut Self ----
model6l <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + (1 | pid) +
                   (1 | house.id) + (1 | region) + cut.self.during.interval, df_first)
saveRDS(model6l, file = "Canoe Capsize Tables/coxme_cut_self.RDS")
...
x <- xtable(results, caption = "Canoe Capsize \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Canoe Capsize Tables/model6l.tex")

# Plot Schoenfeld residuals
pdf(file = "Canoe Capsize Plots/schoenfeld_res7.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model6l))
dev.off()

# Building mixed effects hazard plot for all risks ------------------------

df_hazard_plot <- bind_rows(cbind(extract_coxme_table(readRDS("Canoe Capsize Tables/coxme_tree_fall.RDS")), data.frame(confint(readRDS("Canoe Capsize Tables/coxme_tree_fall.RDS")))),
                            cbind(extract_coxme_table(readRDS("Canoe Capsize Tables/coxme_sickness.RDS")), data.frame(confint(readRDS("Canoe Capsize Tables/coxme_sickness.RDS")))),
                            cbind(extract_coxme_table(readRDS("Canoe Capsize Tables/coxme_fight.RDS")), data.frame(confint(readRDS("Canoe Capsize Tables/coxme_fight.RDS")))),
                            cbind(extract_coxme_table(readRDS("Canoe Capsize Tables/coxme_animal_attack_combined.RDS")), data.frame(confint(readRDS("Canoe Capsize Tables/coxme_animal_attack_combined.RDS")))),
                            cbind(extract_coxme_table(readRDS("Canoe Capsize Tables/coxme_cut_self.RDS")), data.frame(confint(readRDS("Canoe Capsize Tables/coxme_cut_self.RDS")))))
...
ph_df <- bind_rows(data.frame(cox.zph(readRDS("Canoe Capsize Tables/coxme_tree_fall.RDS"))$table),
                   data.frame(cox.zph(readRDS("Canoe Capsize Tables/coxme_sickness.RDS"))$table),
                   data.frame(cox.zph(readRDS("Canoe Capsize Tables/coxme_fight.RDS"))$table),
                   data.frame(cox.zph(readRDS("Canoe Capsize Tables/coxme_animal_attack_combined.RDS"))$table),
                   data.frame(cox.zph(readRDS("Canoe Capsize Tables/coxme_cut_self.RDS"))$table))
...
p
dev.off()
saveRDS(p + labs(x = "", y = "", subtitle = ""), file = "Canoe Capsize Plots/coxme_plot.RDS")


# Model 7: coxme with calendar year ---------------------------------------

## Model 7a: Tree Fall ---- ERROR
# model7a <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + strata(year) + (1 | pid) +
#                    (1 | house.id) + (1 | region) + tree.fall.during.interval, df_first)
# saveRDS(model7a, file = "Canoe Capsize Tables/coxme_tree_fall1.RDS")
#
...
# x <- xtable(results, caption = "Canoe Capsize \\vspace{-1em}")
# align(x) <- "lcccccc"
# print(x, caption.placement = "top", add.to.row = addtorow, file = "Canoe Capsize Tables/model7a.tex")
#
# # Plot Schoenfeld residuals
# pdf(file = "Canoe Capsize Plots/schoenfeld_res1_.pdf", height = 5, width = 7)
# ggcoxzph(cox.zph(model7a))
# dev.off()


## Model 7b: Sickness ----
model7b <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + strata(year) + (1 | pid) +
                   (1 | house.id) + (1 | region) + sickness.during.interval, df_first)
saveRDS(model7b, file = "Canoe Capsize Tables/coxme_sickness1.RDS")
...
x <- xtable(results, caption = "Canoe Capsize \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Canoe Capsize Tables/model7b.tex")

# Plot Schoenfeld residuals
pdf(file = "Canoe Capsize Plots/schoenfeld_res2_.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model7b))
dev.off()


## Model 7c: Fight ----
model7c <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + strata(year) + (1 | pid) +
                   (1 | house.id) + (1 | region) + fought.during.interval, df_first)
saveRDS(model7c, file = "Canoe Capsize Tables/coxme_fight1.RDS")
...
x <- xtable(results, caption = "Canoe Capsize \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Canoe Capsize Tables/model7c.tex")

# Plot Schoenfeld residuals
pdf(file = "Canoe Capsize Plots/schoenfeld_res3_.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model7c))
dev.off()


## Model 7d: Animal Attack (c) ----
model7d <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + strata(year) + (1 | pid) +
                   (1 | house.id) + (1 | region) + Animal_Attack.during.interval, df_first)
saveRDS(model7d, file = "Canoe Capsize Tables/coxme_animal_attack_combined1.RDS")
...
x <- xtable(results, caption = "Canoe Capsize \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Canoe Capsize Tables/model7d.tex")

# Plot Schoenfeld residuals
pdf(file = "Canoe Capsize Plots/schoenfeld_res4_.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model7d))
dev.off()


## Model 7e: Cut Self ----
model7e <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + strata(year) + (1 | pid) +
                   (1 | house.id) + (1 | region) + cut.self.during.interval, df_first)
saveRDS(model7e, file = "Canoe Capsize Tables/coxme_cut_self1.RDS")
...
x <- xtable(results, caption = "Canoe Capsize \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Canoe Capsize Tables/model7e.tex")

# Plot Schoenfeld residuals
pdf(file = "Canoe Capsize Plots/schoenfeld_res5_.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model7e))
dev.off()

# Building mixed effects hazard plot for all risks ------------------------

df_hazard_plot <- bind_rows(cbind(extract_coxme_table(readRDS("Canoe Capsize Tables/coxme_sickness1.RDS")), data.frame(confint(readRDS("Canoe Capsize Tables/coxme_sickness1.RDS")))),
                            cbind(extract_coxme_table(readRDS("Canoe Capsize Tables/coxme_fight1.RDS")), data.frame(confint(readRDS("Canoe Capsize Tables/coxme_fight1.RDS")))),
                            cbind(extract_coxme_table(readRDS("Canoe Capsize Tables/coxme_animal_attack_combined1.RDS")), data.frame(confint(readRDS("Canoe Capsize Tables/coxme_animal_attack_combined1.RDS")))),
                            cbind(extract_coxme_table(readRDS("Canoe Capsize Tables/coxme_cut_self1.RDS")), data.frame(confint(readRDS("Canoe Capsize Tables/coxme_cut_self1.RDS")))))
...
ph_df <- bind_rows(data.frame(cox.zph(readRDS("Canoe Capsize Tables/coxme_sickness1.RDS"))$table),
                   data.frame(cox.zph(readRDS("Canoe Capsize Tables/coxme_fight1.RDS"))$table),
                   data.frame(cox.zph(readRDS("Canoe Capsize Tables/coxme_animal_attack_combined1.RDS"))$table),
                   data.frame(cox.zph(readRDS("Canoe Capsize Tables/coxme_cut_self1.RDS"))$table))
ph_df <- ph_df %>% filter(!duplicated(ph_df))
ph_df <- rownames_to_column(ph_df, "covariate")
...
pdf(file = "Canoe Capsize Plots/coxme_plot_.pdf", height = 6.5, width = 6)
p <- df_hazard_plot %>%
  ggplot() +
  geom_bar(aes(x = reorder(covariate, -exp_beta), y = exp_beta, fill = p.y), stat = "identity") +
  geom_errorbar(aes(x = covariate, ymin = X2.5.., ymax = X97.5..), width = 0.5, size = 0.4) +
...
model8 <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + centered.year + region + (1 | pid) +
                  (1 | house.id), df_first)
saveRDS(model8, file = "Canoe Capsize Tables/coxme_calendar_year.RDS")
...
results <- results %>% rename("Coef" = "beta",
                              ...
                              "Lower CI" = "X2.5..",
                              "Upper CI" = "X97.5..")
rownames(results) <- c("Calendar Year", "Near San Borja", "Upriver")
results <- data.frame(t(results))
results <- data.frame(t(results))
addtorow <- list()
addtorow$pos <- list()
...
x <- xtable(results, caption = "Canoe Capsize \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Canoe Capsize Tables/model8.tex")
...
addtorow$command <- c('\\hline',
                      ...
                      'Region RE & No & No & No & Yes & No & Yes & No \\\\\n',
                      'Region FE & No & No & No & No & Yes & No & Yes \\\\\n',
                      '\\hline')
...
model9 <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + pre_median + (1 | pid) +
                  (1 | house.id) + (1 | region), df_first)
saveRDS(model9, file = "Canoe Capsize Tables/coxme_calendar_year_median.RDS")
...
x <- xtable(results, caption = "Canoe Capsize \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Canoe Capsize Tables/model9.tex")

# Plot Schoenfeld residuals
pdf(file = "Canoe Capsize Plots/schoenfeld_res_median.pdf", height = 5, width = 7)
ggcoxzph(cox.zph(model9))
dev.off()

# Model 10: calendar year tercile split -------------------------------------

model10 <- coxme(Surv(exit, canoe.capsize.during.interval) ~ strata(male) + tercile + (1 | pid) +
                   (1 | house.id) + (1 | region), df_first)
saveRDS(model10, file = "Canoe Capsize Tables/coxme_calendar_year_tercile.RDS")
...
x <- xtable(results, caption = "Canoe Capsize \\vspace{-1em}")
align(x) <- "lcccccc"
print(x, caption.placement = "top", add.to.row = addtorow, file = "Canoe Capsize Tables/model10.tex")

# Plot Schoenfeld residuals
pdf(file = "Canoe Capsize Plots/schoenfeld_res_tercile.pdf", height = 5, width = 7)
...
# Bar plot
pdf(file = "Canoe Capsize Plots/descriptive_plot1.pdf", height = 5,
    width = 7)
df %>%
...
# Line plot
pdf(file = "Canoe Capsize Plots/descriptive_plot2.pdf", height = 5,
    width = 7)
df %>%
  count(age.cat, canoe.capsize.during.interval) %>%
  mutate(prop = prop.table(n)) %>%
...
# df_male_plot <- complete(df_male_plot, age.cat)
# df_male_plot$male <- ifelse(is.na(df_male_plot$male), "Male", df_male_plot$male)
#
# df_female_plot <- complete(df_female_plot, age.cat)
# df_female_plot$male <- ifelse(is.na(df_female_plot$male), "Female", df_female_plot$male)

pdf(file = "Canoe Capsize Plots/descriptive_plot3.pdf", height = 5, width = 7.5)
...
pdf(file = "Canoe Capsize Plots/co_occurrence1a.pdf", height = 5, width = 7)
df_long %>%
  ...
  ggtitle("CANOE CAPSIZE and
  TREE FALL") +
  theme(plot.title = element_text(size = 25)) +
  xlab("Age of Co-occurrence") +
  ylab("Percentage of Intervals (489 Intervals)")
dev.off()

# By gender
pdf(file = "Canoe Capsize Plots/co_occurrence1b.pdf", height = 5, width = 10)
df_long %>%
...
pdf(file = "Canoe Capsize Plots/co_occurrence2a.pdf", height = 5, width = 7)
df_long %>%
  ...
  scale_y_continuous(labels = scales::percent) +
  theme_classic(base_size = 15) +
  ggtitle("CANOE CAPSIZE and SICKNESS") +
  theme(plot.title = element_text(size = 25)) +
  xlab("Age of Co-occurrence") +
  ylab("Percentage of Intervals (489 Intervals)")
dev.off()
...
# By gender
pdf(file = "Canoe Capsize Plots/co_occurrence2b.pdf", height = 5, width = 10)
df_long %>%
...
pdf(file = "Canoe Capsize Plots/co_occurrence3a.pdf", height = 5, width = 7)
df_long %>%
...
# By gender
pdf(file = "Canoe Capsize Plots/co_occurrence3b.pdf", height = 5, width = 10)
df_long %>%
...
pdf(file = "Canoe Capsize Plots/co_occurrence4a.pdf", height = 5, width = 7.5)
df_long %>%
...
# By gender
pdf(file = "Canoe Capsize Plots/co_occurrence4b.pdf", height = 5, width = 10)
df_long %>%
...
pdf(file = "Canoe Capsize Plots/co_occurrence5a.pdf", height = 5, width = 7.5)
df_long %>%
  ...
  scale_y_continuous(labels = scales::percent) +
  theme_classic(base_size = 15) +
  ggtitle("CANOE CAPSIZE and FIGHT") +
  theme(plot.title = element_text(size = 25)) +
  xlab("Age of Co-occurrence") +
  ylab("Percentage of Intervals (489 Intervals)")
dev.off()
...
# By gender
pdf(file = "Canoe Capsize Plots/co_occurrence5b.pdf", height = 5, width = 10)
df_long %>%
...
pdf(file = "Canoe Capsize Plots/co_occurrence6a.pdf", height = 5, width = 7)
df_long %>%
...
# By gender
pdf(file = "Canoe Capsize Plots/co_occurrence6b.pdf", height = 5, width = 10)
df_long %>%
...
### ANIMAL ATTACK (c) ----
# Distribution of co-occurring ANIMAL ATTACK (c) within canoe capsize intervals
pdf(file = "Canoe Capsize Plots/co_occurrence7a.pdf", height = 5, width = 7)
df_long %>%
...
# By gender
pdf(file = "Canoe Capsize Plots/co_occurrence7b.pdf", height = 5, width = 10)
df_long %>%
...
df_long$event <- ifelse(df_long$event == 1, "Canoe Capsize
Occurred", "Canoe Capsize Did
Not Occur")
...
pdf(file = "Canoe Capsize Plots/co_occurrence1c.pdf", height = 4, width = 6.5)
df_long %>%
  ...
  theme_classic(base_size = 12) +
  ggtitle("CANOE CAPSIZE and TREE FALL") +
  theme(plot.title = element_text(size = 25)) +
  xlab("") +
  ylab("Percentage of Intervals (489 Intervals)") +
...
pdf(file = "Canoe Capsize Plots/co_occurrence1d.pdf", height = 4, width = 7)
df_long %>%
...
# By region
pdf(file = "Canoe Capsize Plots/co_occurrence1e.pdf", height = 4.5, width = 7)
df_long %>%
...
pdf(file = "Canoe Capsize Plots/co_occurrence2c.pdf", height = 4, width = 6.5)
df_long %>%
...
# For males and females
pdf(file = "Canoe Capsize Plots/co_occurrence2d.pdf", height = 4, width = 7)
df_long %>%
...
# By region
pdf(file = "Canoe Capsize Plots/co_occurrence2e.pdf", height = 4, width = 7.5)
df_long %>%
...
pdf(file = "Canoe Capsize Plots/co_occurrence3c.pdf", height = 4, width = 6)
df_long %>%
...
# For males and females
pdf(file = "Canoe Capsize Plots/co_occurrence3d.pdf", height = 4, width = 7)
df_long %>%
...
# By region
pdf(file = "Canoe Capsize Plots/co_occurrence3e.pdf", height = 4, width = 7)
df_long %>%
...
pdf(file = "Canoe Capsize Plots/co_occurrence4c.pdf", height = 4, width = 6)
df_long %>%
...
# For males and females
pdf(file = "Canoe Capsize Plots/co_occurrence4d.pdf", height = 4, width = 7.5)
df_long %>%
  ...
  scale_y_continuous(labels = scales::percent_format(scale = 1)) +
  theme_classic(base_size = 12) +
  ggtitle("CANOE CAPSIZE and ANIMAL ATTACK") +
  theme(plot.title = element_text(size = 25)) +
  xlab("") +
  ylab("Percentage of Intervals (489 Intervals)") +
  labs(fill = "") +
...
# By region
pdf(file = "Canoe Capsize Plots/co_occurrence4e.pdf", height = 4.5, width = 7)
df_long %>%
...
pdf(file = "Canoe Capsize Plots/co_occurrence5c.pdf", height = 4, width = 6)
df_long %>%
...
# For males and females
pdf(file = "Canoe Capsize Plots/co_occurrence5d.pdf", height = 4, width = 8)
df_long %>%
...
# By region
pdf(file = "Canoe Capsize Plots/co_occurrence5e.pdf", height = 4.5, width = 7.5)
df_long %>%
...
pdf(file = "Canoe Capsize Plots/co_occurrence6c.pdf", height = 4, width = 6)
df_long %>%
  ...
  scale_y_continuous(labels = scales::percent_format(scale = 1)) +
  theme_classic(base_size = 12) +
  ggtitle("CANOE CAPSIZE and CUT SELF") +
  theme(plot.title = element_text(size = 25)) +
  xlab("") +
  ylab("Percentage of Intervals (489 Intervals)") +
  scale_fill_manual(values = c("lightcyan2", "lightcoral")) +
...
# For males and females
pdf(file = "Canoe Capsize Plots/co_occurrence6d.pdf", height = 4, width = 7)
df_long %>%
...
# By region
pdf(file = "Canoe Capsize Plots/co_occurrence6e.pdf", height = 4.5, width = 7)
df_long %>%
...
pdf(file = "Canoe Capsize Plots/co_occurrence7c.pdf", height = 4, width = 6)
df_long %>%
...
# For males and females
pdf(file = "Canoe Capsize Plots/co_occurrence7d.pdf", height = 4, width = 7)
df_long %>%
...
# By region
pdf(file = "Canoe Capsize Plots/co_occurrence7e.pdf", height = 4.5, width = 7)
df_long %>%
...
## Survival Function ----
fit <- survfit(Surv(enter, exit, canoe.capsize.during.interval) ~ 1, data = df)
pdf(file = "Canoe Capsize Plots/survival_function.pdf", height = 5, width = 6)
...
ggsurvplot(fit2, font.title = c("30"), conf.int = TRUE, legend = "right",
           ...
           title = "Canoe Capsize", axes.offset = F, break.x.by = 5,
...
## Hazard Function ----
### bshazard ----
fit <- bshazard(Surv(enter, exit, canoe.capsize.during.interval) ~ 1, data = df)
df_surv <- data.frame(time = fit$time, hazard = fit$hazard,
                      lower.ci = fit$lower.ci, upper.ci = fit$upper.ci)
pdf(file = "Canoe Capsize Plots/hazard_function1.pdf", height = 5)
...
mfit <- muhaz(df$exit, df$canoe.capsize.during.interval)
plot(mfit, main = "Canoe Capsize")
dev.off()

pdf(file = "Canoe Capsize Plots/hazard_function3.pdf", height = 5)
kfit <- kphaz.fit(df$exit, df$canoe.capsize.during.interval)
kphaz.plot(kfit, main = "Canoe Capsize")
dev.off()

# By gender
fit <- bshazard(Surv(enter, exit, canoe.capsize.during.interval) ~ 1, data = subset(df, male == "Male"))
summary(fit)
df_surv <- data.frame(time = fit$time, hazard = fit$hazard,
                      lower.ci = fit$lower.ci, upper.ci = fit$upper.ci)
df_surv$Sex <- "Male"

fit2 <- bshazard(Surv(enter, exit, canoe.capsize.during.interval) ~ 1, data = subset(df, male == "Female"))
summary(fit2)
...
pdf(file = "Canoe Capsize Plots/hazard_function4.pdf", height = 5)
...
pdf(file = "Canoe Capsize Plots/hazard_function5.pdf", height = 5)
ggplot(df_surv4) +
...
# fit <- stpm2(Surv(enter, exit, canoe.capsize.during.interval) ~ male, data = df)
# plot(fit, newdata = data.frame(male = 1), type = "hr", var = "male")

## Cumulative hazard function ----
fit <- survfit(Surv(enter, exit, canoe.capsize.during.interval) ~ 1, data = df)
pdf(file = "Canoe Capsize Plots/cumhaz_plot1.pdf", height = 5)
autoplot(fit, censor.shape = '|', censor.colour = "purple",
...
# By gender
fit2 <- survfit(Surv(enter, exit, canoe.capsize.during.interval) ~ male, data = df)
pdf(file = "Canoe Capsize Plots/cumhaz_plot2.pdf", height = 5)
ggsurvplot(fit2, font.title = c("30"), conf.int = TRUE, legend = "right",
           legend.labs = c("Female", "Male"),
           legend.title = "Sex", palette = c("orchid2", "dodgerblue2"),
           title = "Canoe Capsize", fun = "cumhaz", axes.offset = F, break.x.by = 5,
           subtitle = "388 Individuals, 13,451 Intervals") +
  xlab("Age in years") +
  ylab("Cumulative hazard")
dev.off()
