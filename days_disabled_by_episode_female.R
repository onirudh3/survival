...
p
saveRDS(p, file = "Days Disabled Episodes/sickness_female.RDS")
...
p <- dx %>% ggplot(aes(x = cut.self.during.interval.episode, y = total_days_disabled)) +
  ...
  theme_classic() +
  ggtitle("Cut Self") +
  labs(subtitle = "p-value = 0.002") +
  theme(plot.title = element_text(size = 30, hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5)) +
  xlab("Episode") +
  ylab("Total days disabled")
p
saveRDS(p, file = "Days Disabled Episodes/cut_self_female.RDS")
...
p <- dx %>% ggplot(aes(x = Animal_Attack.during.interval.episode, y = total_days_disabled)) +
  ...
  labs(subtitle = "p-value = 0.73") +
  theme(plot.title = element_text(size = 30, hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5)) +
  xlab("Episode") +
  ylab("Total days disabled")
p
saveRDS(p, file = "Days Disabled Episodes/Animal_Attack_female.RDS")
...
p <- dx %>% ggplot(aes(x = tree.fall.during.interval.episode, y = total_days_disabled)) +
  ...
  theme_classic() +
  ggtitle("Tree Fall") +
  labs(subtitle = "p-value = 0.12") +
  theme(plot.title = element_text(size = 30, hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5)) +
  xlab("Episode") +
  ylab("Total days disabled")
p
saveRDS(p, file = "Days Disabled Episodes/tree_fall_female.RDS")
...
p <- dx %>% ggplot(aes(x = fought.during.interval.episode, y = total_days_disabled)) +
  ...
  theme_classic() +
  ggtitle("Fight") +
  labs(subtitle = "p-value = 0.47") +
  theme(plot.title = element_text(size = 30, hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5)) +
  xlab("Episode") +
  ylab("Total days disabled")
p
saveRDS(p, file = "Days Disabled Episodes/fight_female.RDS")
...
# Test for group differences ALL OBS IN SAME GROUP
...
p <- dx %>% ggplot(aes(x = canoe.capsize.during.interval.episode, y = total_days_disabled)) +
  ...
  ylab("Total days disabled")
p
saveRDS(p, file = "Days Disabled Episodes/canoe_capsize_female.RDS")

# Panel plot --------------------------------------------------------------

figure <- ggarrange(readRDS("Days Disabled Episodes/sickness_female.RDS") + rremove("ylab") + rremove("xlab"),
                    readRDS("Days Disabled Episodes/cut_self_female.RDS") + rremove("ylab") + rremove("xlab"),
                    readRDS("Days Disabled Episodes/Animal_Attack_female.RDS") + rremove("ylab") + rremove("xlab"),
                    readRDS("Days Disabled Episodes/tree_fall_female.RDS") + rremove("ylab") + rremove("xlab"),
                    readRDS("Days Disabled Episodes/fight_female.RDS") + rremove("ylab") + rremove("xlab"),
                    readRDS("Days Disabled Episodes/canoe_capsize_female.RDS") + rremove("ylab") + rremove("xlab"))

pdf(file = "Days Disabled Episodes/panel_plot_female.pdf", height = 9, width = 15)
